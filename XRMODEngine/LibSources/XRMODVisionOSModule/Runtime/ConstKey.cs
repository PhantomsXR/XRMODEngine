...
namespace Phantom.XRMOD.VisionOSModule.Runtime
{
    public class ConstKey
    {
        ...
        public const string CONST_DEFAULT_PLANE_VISUALIZER_NAME = "DefaultPlaneVisualizer";
        public const string CONST_DEFAULT_MESH_VISUALIZER_NAME = "DefaultMeshVisualizer";
        public const string CONST_DEFAULT_POINT_CLOUD_VISUALIZER_NAME = "DefaultPointCloudVisualizer";
        public const string CONST_DEFAULT_FEATHERED_PLANE_VISUALIZER = "FeatheredPlaneVisualizer";
