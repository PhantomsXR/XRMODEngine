...
{
    public class AudioEchoFilterValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<AudioEchoFilter>().ToList()
                    : convertedArray.Cast<AudioEchoFilter>().ToArray());
            return true;
