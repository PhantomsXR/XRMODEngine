...
{
    public class RotationConstraintValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<RotationConstraint>().ToList()
                    : convertedArray.Cast<RotationConstraint>().ToArray());
            return true;
