...
{
    public class TextMeshProUGUIValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<TextMeshProUGUI>().ToList()
                    : convertedArray.Cast<TextMeshProUGUI>().ToArray());
            return true;
