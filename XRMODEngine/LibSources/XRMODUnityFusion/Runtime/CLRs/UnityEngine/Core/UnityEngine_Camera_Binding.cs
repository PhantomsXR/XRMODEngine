...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_Camera_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_orthographicSize_0);

        }

        static StackObject* get_orthographicSize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
