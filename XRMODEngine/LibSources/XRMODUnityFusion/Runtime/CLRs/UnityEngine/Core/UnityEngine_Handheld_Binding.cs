...
namespace UnityFusion.Runtime.Generated
{
 ...
 BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static | BindingFlags.DeclaredOnly;
            ...
            args =
 new Type[]{typeof(System.String), typeof(UnityEngine.Color), typeof(UnityEngine.FullScreenMovieControlMode), typeof(UnityEngine.FullScreenMovieScalingMode)};
            ...
            args =
 new Type[]{typeof(System.String), typeof(UnityEngine.Color), typeof(UnityEngine.FullScreenMovieControlMode)};
            method = type.GetMethod("PlayFullScreenMovie", flag, null, args, null);
        ...
        static StackObject* PlayFullScreenMovie_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.FullScreenMovieScalingMode @scalingMode =
 (UnityEngine.FullScreenMovieScalingMode)typeof(UnityEngine.FullScreenMovieScalingMode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.FullScreenMovieControlMode @controlMode =
 (UnityEngine.FullScreenMovieControlMode)typeof(UnityEngine.FullScreenMovieControlMode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            UnityEngine.Color @bgColor =
 (UnityEngine.Color)typeof(UnityEngine.Color).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 4);
            System.String @path =
 (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method =
 UnityEngine.Handheld.PlayFullScreenMovie(@path, @bgColor, @controlMode, @scalingMode);
