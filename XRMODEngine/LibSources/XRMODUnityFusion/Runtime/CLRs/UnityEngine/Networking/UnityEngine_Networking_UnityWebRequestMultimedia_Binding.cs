...
{
    unsafe class UnityEngine_Networking_UnityWebRequestMultimedia_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Networking.UnityWebRequestMultimedia);
        ...
        static StackObject* GetAudioClip_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.Networking.UnityWebRequestMultimedia.GetAudioClip(@uri, @audioType);
        ...
        static StackObject* GetAudioClip_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
