...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_FixedJoint2D_Binding
    {
        ...
        static StackObject* get_dampingRatio_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.FixedJoint2D instance_of_this_method = (UnityEngine.FixedJoint2D)typeof(UnityEngine.FixedJoint2D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* get_referenceAngle_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
