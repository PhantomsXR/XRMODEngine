...
namespace UnityFusion.Runtime.Generated
{
    unsafe class System_Collections_Generic_Dictionary_2_String_Texture2D_Binding
    {
        ...
        static StackObject* TryGetValue_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Texture2D @value = (UnityEngine.Texture2D)typeof(UnityEngine.Texture2D).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
