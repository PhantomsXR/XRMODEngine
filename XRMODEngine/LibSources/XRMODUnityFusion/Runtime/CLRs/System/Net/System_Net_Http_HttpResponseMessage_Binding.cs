...
namespace UnityFusion.Runtime.Generated
{
    unsafe class System_Net_Http_HttpResponseMessage_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, EnsureSuccessStatusCode_0);
            args = new Type[]{};
            method = type.GetMethod("get_Content", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Content_1);


        }


        static StackObject* EnsureSuccessStatusCode_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_Content_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
