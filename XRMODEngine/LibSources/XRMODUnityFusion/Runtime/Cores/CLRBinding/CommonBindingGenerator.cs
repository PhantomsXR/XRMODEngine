...
namespace UnityFusion.Runtime.CLRBinding
{
    static class CommonBindingGenerator
    {
        ...
        internal static string GenerateCommonCode(this Type type, string typeClsName)
        {
            ...
            if (type.IsPrimitive)
            {
                sb.AppendLine(string.Format("        static {0} GetInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack)", typeClsName));
                sb.AppendLine("        {");
            ...
            {
                sb.AppendLine(string.Format("        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref {0} instance_of_this_method)", typeClsName));
                sb.AppendLine("        {");
                sb.AppendLine(@"            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
