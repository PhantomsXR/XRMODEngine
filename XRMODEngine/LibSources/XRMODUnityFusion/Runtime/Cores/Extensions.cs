...
namespace UnityFusion.Runtime
{
    public static class Extensions
    {
        public static bool GetJITFlags(this Mono.Cecil.CustomAttribute attribute, Enviorment.AppDomain appdomain, out int flags)
        {
            ...
            flags = UnityFusionJITFlags.None;
            if (at == appdomain.JITAttributeType)
            {
                if (attribute.HasConstructorArguments)
                {
                    ...
                    flags = UnityFusionJITFlags.JITOnDemand;
                return true;
            }
            else
                return false;
        ...
        {
            if (value is UnityFusion.Runtime.Enviorment.CrossBindingAdaptorType)
                return ((UnityFusion.Runtime.Enviorment.CrossBindingAdaptorType)value).ILInstance.Type.ReflectionType;
            if (value is UnityFusion.Runtime.Intepreter.ILTypeInstance)
                return ((UnityFusion.Runtime.Intepreter.ILTypeInstance)value).Type.ReflectionType;
            else
