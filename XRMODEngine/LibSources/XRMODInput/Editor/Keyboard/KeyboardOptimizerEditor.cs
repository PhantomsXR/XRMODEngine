...
namespace Phantom.XRMOD.XRMODInput.Editor.Keyboard
{
    ...
    /// </summary>
    [UnityEditor.CustomEditor(typeof(KeyboardOptimizer), true), UnityEditor.CanEditMultipleObjects]
    public class KeyboardOptimizerEditor : BaseInteractionEditor
    {
        /// <summary><see cref="UnityEditor.SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="KeyboardOptimizer.optimizeOnStart"/>.</summary>
