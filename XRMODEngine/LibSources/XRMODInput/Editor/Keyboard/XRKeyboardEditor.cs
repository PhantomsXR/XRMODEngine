...
namespace Phantom.XRMOD.XRMODInput.Editor.Keyboard
{
    ...
    /// </summary>
    [UnityEditor.CustomEditor(typeof(XRKeyboard), true), UnityEditor.CanEditMultipleObjects]
    public class XRKeyboardEditor : BaseInteractionEditor
    {
        /// <summary><see cref="UnityEditor.SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XRKeyboard.submitOnEnter"/>.</summary>
