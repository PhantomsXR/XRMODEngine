...
{
    unsafe class UnityEngine_XR_Interaction_Toolkit_Transformers_XRBaseGrabTransformer_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Transformers.XRBaseGrabTransformer);
        ...
        static StackObject* OnLink_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.XR.Interaction.Toolkit.Transformers.XRBaseGrabTransformer instance_of_this_method = (UnityEngine.XR.Interaction.Toolkit.Transformers.XRBaseGrabTransformer)typeof(UnityEngine.XR.Interaction.Toolkit.Transformers.XRBaseGrabTransformer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.OnLink(@grabInteractable);
