...
{
    unsafe class Fusion_Addons_KCC_FloatAccumulator_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Fusion.Addons.KCC.FloatAccumulator);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Fusion.Addons.KCC.FloatAccumulator());
            app.RegisterCLRCreateArrayInstance(type, s => new Fusion.Addons.KCC.FloatAccumulator[s]);
        ...
        static StackObject* get_AccumulatedValue_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Addons.KCC.FloatAccumulator instance_of_this_method = (Fusion.Addons.KCC.FloatAccumulator)typeof(Fusion.Addons.KCC.FloatAccumulator).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        {
            return ((Fusion.Addons.KCC.FloatAccumulator)o).SmoothingWindow;
        }

        static StackObject* CopyToStack_SmoothingWindow_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Fusion.Addons.KCC.FloatAccumulator)o).SmoothingWindow;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Fusion.Addons.KCC.FloatAccumulator)o).SmoothingWindow = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_SmoothingWindow_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Fusion.Addons.KCC.FloatAccumulator)o).SmoothingWindow = @SmoothingWindow;
            return ptr_of_this_method;
        }

        static object get_UseDirectionFilter_1(ref object o)
        {
            return ((Fusion.Addons.KCC.FloatAccumulator)o).UseDirectionFilter;
        }

        static StackObject* CopyToStack_UseDirectionFilter_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Fusion.Addons.KCC.FloatAccumulator)o).UseDirectionFilter;
        ...
        {
            ((Fusion.Addons.KCC.FloatAccumulator)o).UseDirectionFilter = (System.Boolean)v;
        }
        ...
        static StackObject* AssignFromStack_UseDirectionFilter_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Fusion.Addons.KCC.FloatAccumulator)o).UseDirectionFilter = @UseDirectionFilter;
            return ptr_of_this_method;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.KCC.FloatAccumulator();
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.KCC.FloatAccumulator(@smoothingWindow);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.KCC.FloatAccumulator(@smoothingWindow, @useDirectionFilter);
