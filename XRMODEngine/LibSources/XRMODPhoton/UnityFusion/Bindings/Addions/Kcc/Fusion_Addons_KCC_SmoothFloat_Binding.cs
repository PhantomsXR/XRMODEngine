...
{
    unsafe class Fusion_Addons_KCC_SmoothFloat_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.Addons.KCC.SmoothFloat);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new Fusion.Addons.KCC.SmoothFloat[s]);
        ...
        static StackObject* FilterValues_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Addons.KCC.SmoothFloat instance_of_this_method = (Fusion.Addons.KCC.SmoothFloat)typeof(Fusion.Addons.KCC.SmoothFloat).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.KCC.SmoothFloat(@records);
