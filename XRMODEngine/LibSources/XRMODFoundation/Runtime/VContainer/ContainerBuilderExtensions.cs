...
namespace VContainer
{
    public static class ContainerBuilderExtensions
    {
        ...
        public static RegistrationBuilder Register(
            ...
            Type implementationType,
            Lifetime lifetime) =>
            builder.Register(implementationType, lifetime).As(interfaceType1, interfaceType2);
        ...
        public static RegistrationBuilder Register(
            ...
            Type interfaceType3,
            Type implementationType,
            Lifetime lifetime) => builder.Register(implementationType, lifetime)
            .As(interfaceType1, interfaceType2, interfaceType3);
        ...
        public static RegistrationBuilder Register<TInterface>(
            ...
            Lifetime lifetime)
            => builder.Register(new FuncRegistrationBuilder(container => implementationConfiguration(container),
        ...
        public static RegistrationBuilder RegisterInstance(
            this IContainerBuilder builder,
            object instance,
            Type implementationType)=> builder.Register(new InstanceRegistrationBuilder(instance,implementationType)).As(implementationType);
        ...
        public static RegistrationBuilder RegisterFactory<TParam1, TParam2, T>(
            ...
            Lifetime lifetime)
            => builder.Register(
                new FuncRegistrationBuilder(factoryFactory, typeof(Func<TParam1, TParam2, T>), lifetime));
        ...
        public static RegistrationBuilder RegisterFactory<TParam1, TParam2, TParam3, T>(
            ...
            Lifetime lifetime)
            => builder.Register(new FuncRegistrationBuilder(factoryFactory, typeof(Func<TParam1, TParam2, TParam3, T>),
                lifetime));
        ...
        public static RegistrationBuilder RegisterFactory<TParam1, TParam2, TParam3, TParam4, T>(
            ...
            Lifetime lifetime)
            => builder.Register(new FuncRegistrationBuilder(factoryFactory,
