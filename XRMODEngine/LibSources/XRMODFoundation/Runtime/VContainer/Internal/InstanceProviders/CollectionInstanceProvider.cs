...
namespace VContainer.Internal
{
    ...
    sealed class CollectionInstanceProvider : IInstanceProvider, IEnumerable<Registration>
    {
        ...
        public CollectionInstanceProvider(Type elementType)
        {
            ...
            {
                var tmp_ElementType = tmp_AppDomain.GetType(elementType.FullName); 
                if (tmp_ElementType != null)
                {
                    ImplementationType = tmp_ElementType.MakeArrayType(1).ReflectionType;
        ...
        internal object SpawnInstance(IObjectResolver currentScope,
