...
{
    public class ScriptingBackendValidationDrawer : AbstractDrawer,IFixer
    {
        private const string PLATFORM_HELP = "All Application need 64bit";

        public override VisualElement CreateVisualElement()
        {
            return DrawUtility.CreateSettingStateUI("Scripting Backend", PLATFORM_HELP, () => CheckScriptingBackend(),
                CheckedTexture,
                ErrorTexture,
                FixScriptBackend);
        }

        private bool CheckScriptingBackend()
        {
