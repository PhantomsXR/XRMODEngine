...
{
    unsafe class Phantom_XRMOD_BaseFeatures_Runtime_BuildEventSystemCommand_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand[s]);
        ...
        static StackObject* Execute_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand instance_of_this_method = (Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand)typeof(Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.BaseFeatures.Runtime.BuildEventSystemCommand();
