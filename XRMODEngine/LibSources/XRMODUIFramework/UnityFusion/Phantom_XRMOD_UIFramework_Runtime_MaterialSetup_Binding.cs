...
{
    unsafe class Phantom_XRMOD_UIFramework_Runtime_MaterialSetup_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.UIFramework.Runtime.MaterialSetup);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.UIFramework.Runtime.MaterialSetup());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.UIFramework.Runtime.MaterialSetup[s]);
        ...
        static StackObject* Validate_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Phantom.XRMOD.UIFramework.Runtime.MaterialSetup instance_of_this_method = (Phantom.XRMOD.UIFramework.Runtime.MaterialSetup)typeof(Phantom.XRMOD.UIFramework.Runtime.MaterialSetup).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        {
            return ((Phantom.XRMOD.UIFramework.Runtime.MaterialSetup)o).Radius;
        }

        static StackObject* CopyToStack_Radius_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.UIFramework.Runtime.MaterialSetup)o).Radius;
        ...
        {
            ((Phantom.XRMOD.UIFramework.Runtime.MaterialSetup)o).Radius = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_Radius_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.UIFramework.Runtime.MaterialSetup)o).Radius = @Radius;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.UIFramework.Runtime.MaterialSetup();
