...
// //
// // This file is part of the Goap.Runtime.
// //
...
namespace Goap.Runtime
{
    public class CapabilityBuilder
    {
        ...
        internal TargetSensorBuilder AddTargetSensor(Type _type)
        {
            var targetSensorBuilder = TargetSensorBuilder.Create(_type, this.targetKeyBuilder);
        ...
        internal ActionBuilder AddAction(Type _type)
        {
            var actionBuilder = ActionBuilder.Create(_type, this.worldKeyBuilder, this.targetKeyBuilder);
        ...
        internal GoalBuilder AddGoal(Type _goalType)
        {
            var goalBuilder = GoalBuilder.Create(_goalType, this.worldKeyBuilder);
        ...
        internal WorldSensorBuilder AddWorldSensor(Type _type)
        {
            var worldSensorBuilder = WorldSensorBuilder.Create(_type, this.worldKeyBuilder);
        ...
        internal MultiSensorBuilder AddMultiSensor(Type _type)
        {
            var multiSensorBuilder = MultiSensorBuilder.Create(_type);
