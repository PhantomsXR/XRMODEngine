...
{
    unsafe class TargetSensorBuilder_LocalTargetSensorBaseAdapter_Binding_Adapter_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            Type[] args;
            Type type =
                typeof(Goap.Runtime.TargetSensorBuilder<
                    UnityFusion.CLRBinding.Adapter.LocalTargetSensorBaseAdapter.Adapter>);
            ...
            bool isNewObj)
        {
            ...
            Goap.Runtime.TargetSensorBuilder instance_of_this_method =
                (Goap.Runtime.TargetSensorBuilder) typeof(Goap.Runtime.TargetSensorBuilder).CheckCLRTypes(
