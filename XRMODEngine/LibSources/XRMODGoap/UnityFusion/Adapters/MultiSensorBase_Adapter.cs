...
{   
    public class MultiSensorBaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(Goap.Runtime.MultiSensorBase);
            }
        }
        ...
        public class Adapter : Goap.Runtime.MultiSensorBase, CrossBindingAdaptorType
        {
            CrossBindingMethodInfo mCreated_0 = new CrossBindingMethodInfo("Created");
            ...
            {
                mCreated_0.Invoke(this.instance);
            }
