...
{   
    public class LocalWorldSensorBaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(Goap.Runtime.LocalWorldSensorBase);
            }
        }
        ...
        public class Adapter : Goap.Runtime.LocalWorldSensorBase, CrossBindingAdaptorType
        {
            ...
            CrossBindingFunctionInfo<Goap.Agent.Core.IActionReceiver, Goap.Agent.Core.IComponentReference, Goap.Core.SenseValue> mSense_3 = new CrossBindingFunctionInfo<Goap.Agent.Core.IActionReceiver, Goap.Agent.Core.IComponentReference, Goap.Core.SenseValue>("Sense");
            ...
            public override Goap.Core.SenseValue Sense(Goap.Agent.Core.IActionReceiver agent, Goap.Agent.Core.IComponentReference references)
            {
                if (mSense_3.CheckShouldInvokeBase(this.instance))
                    return base.Sense(agent, references);
                else
                    return mSense_3.Invoke(this.instance, agent, references);
            }
