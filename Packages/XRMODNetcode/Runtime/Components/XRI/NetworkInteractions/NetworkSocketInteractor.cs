    ...
    public class NetworkSocketInteractor : NetworkBehaviour
    {
        ...
        public override void OnNetworkDespawn()
        {
            ...
            XRGrabInteractable grabInteractable =
                m_SocketInteractor.GetOldestInteractableSelected() as XRGrabInteractable;
            m_SocketInteractor.enabled = false;
            if (grabInteractable != null)
            {
                NetworkPhysicsInteractable networkInteractable =
                    grabInteractable.GetComponent<NetworkPhysicsInteractable>();
