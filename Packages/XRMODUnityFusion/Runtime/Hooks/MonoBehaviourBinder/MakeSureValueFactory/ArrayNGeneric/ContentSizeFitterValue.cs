...
{
    public class ContentSizeFitterValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<ContentSizeFitter>().ToList()
                    : convertedArray.Cast<ContentSizeFitter>().ToArray());
            return true;
