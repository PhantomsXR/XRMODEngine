...
{
    public class AudioChorusFilterValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<AudioChorusFilter>().ToList()
                    : convertedArray.Cast<AudioChorusFilter>().ToArray());
            return true;
