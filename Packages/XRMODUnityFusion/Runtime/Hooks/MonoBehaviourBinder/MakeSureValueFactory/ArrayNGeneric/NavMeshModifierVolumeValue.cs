...
{
    public class NavMeshModifierVolumeValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<NavMeshModifierVolume>().ToList()
                    : convertedArray.Cast<NavMeshModifierVolume>().ToArray());
            return true;
