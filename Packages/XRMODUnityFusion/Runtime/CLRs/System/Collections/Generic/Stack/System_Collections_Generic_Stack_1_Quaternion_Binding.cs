...
{
    unsafe class System_Collections_Generic_Stack_1_Quaternion_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Stack<UnityEngine.Quaternion>);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.Stack<UnityEngine.Quaternion>());
            app.RegisterCLRCreateArrayInstance(type, s => new System.Collections.Generic.Stack<UnityEngine.Quaternion>[s]);
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Stack<UnityEngine.Quaternion> instance_of_this_method = (System.Collections.Generic.Stack<UnityEngine.Quaternion>)typeof(System.Collections.Generic.Stack<UnityEngine.Quaternion>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Contains_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Quaternion @item = (UnityEngine.Quaternion)typeof(UnityEngine.Quaternion).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* CopyTo_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.Quaternion[] @array = (UnityEngine.Quaternion[])typeof(UnityEngine.Quaternion[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Quaternion>();
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Quaternion>(@capacity);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityEngine.Quaternion> @collection = (System.Collections.Generic.IEnumerable<UnityEngine.Quaternion>)typeof(System.Collections.Generic.IEnumerable<UnityEngine.Quaternion>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Quaternion>(@collection);
