...
{
    unsafe class System_Collections_Generic_Stack_1_XRMODBehaviourAdapter_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter)};
            method = type.GetMethod("Contains", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Contains_2);
            args = new Type[]{typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter[]), typeof(System.Int32)};
            ...
            args = new Type[]{typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter).MakeByRefType()};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>());
            app.RegisterCLRCreateArrayInstance(type, s => new System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>[s]);
            ...
            args = new Type[]{typeof(System.Collections.Generic.IEnumerable<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>)};
            method = type.GetConstructor(flag, null, args, null);
        ...
        static StackObject* get_Count_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter> instance_of_this_method = (System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>)typeof(System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Contains_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter @item = (UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter)typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* CopyTo_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter[] @array = (UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter[])typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* TryPeek_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter @result = (UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter)typeof(UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter[];
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>();
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>(@capacity);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter> @collection = (System.Collections.Generic.IEnumerable<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>)typeof(System.Collections.Generic.IEnumerable<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = new System.Collections.Generic.Stack<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter>(@collection);
