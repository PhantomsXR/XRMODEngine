...
{
    unsafe class System_Collections_Generic_List_1_Adaptor_Binding_Enumerator_Binding
    {
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method,
           AutoList __mStack,
            ref System.Collections.Generic.List<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter.Adapter>.
                Enumerator
            ...
            switch (ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.ArrayReference:
                {
                    var instance_of_arrayReference =
                        __mStack[ptr_of_this_method->Value] as System.Collections.Generic.List<
                            UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter.Adapter>.Enumerator[];
        ...
        static StackObject* MoveNext_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
            CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
