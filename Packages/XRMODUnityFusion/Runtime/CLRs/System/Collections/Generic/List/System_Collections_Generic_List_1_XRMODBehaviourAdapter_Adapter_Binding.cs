...
{
    unsafe public class System_Collections_Generic_List_1_XRMODBehaviourAdapter_Adapter_Binding
    {
        ...
        static StackObject* AddRange_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter.Adapter>
                @collection =
                    (System.Collections.Generic.IEnumerable<
                        UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter.Adapter>)
                    typeof(System.Collections.Generic.IEnumerable<
                        UnityFusion.CLRBinding.Adapter.XRMODBehaviourAdapter.Adapter>).CheckCLRTypes(
        ...
        static StackObject* GetEnumerator_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
        ...
        static StackObject* get_Count_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_Item_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
