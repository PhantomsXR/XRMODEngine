...
using UnityFusion.Mono.Cecil.Cil;
...
namespace UnityFusion.Runtime.Enviorment
{
    ...
    public class AppDomain
    {
        ...
        public unsafe AppDomain(int defaultJITFlags = UnityFusionJITFlags.None)
        {
            ...
            this.defaultJITFlags = defaultJITFlags & (UnityFusionJITFlags.JITImmediately | UnityFusionJITFlags.JITOnDemand);
        }
        ...
        public void LoadAssembly(System.IO.Stream stream, System.IO.Stream symbol, ISymbolReaderProvider symbolReader)
        {
            ...
            if (voidType == null)
            {
                ...
                jitAttributeType = GetType("UnityFusion.Runtime.UnityFusionJITAttribute");
            }
#if DEBUG && !DISABLE_UNITYFUSION_DEBUG
