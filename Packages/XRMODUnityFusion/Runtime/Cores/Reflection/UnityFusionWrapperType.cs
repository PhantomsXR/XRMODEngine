...
{
    public class UnityFusionWrapperType : Type
    {
        CLRType type;
        Type et;
        ...
        public UnityFusionWrapperType(CLRType t)
        {
            type = t;
            et = t.TypeForCLR;
        }
        ...
        public override bool IsAssignableFrom(Type c)
        {
            if (c is UnityFusionWrapperType)
                c = ((UnityFusionWrapperType)c).RealType;
            if (c is UnityFusionType)
                c = ((UnityFusionType)c).ILType.TypeForCLR;
