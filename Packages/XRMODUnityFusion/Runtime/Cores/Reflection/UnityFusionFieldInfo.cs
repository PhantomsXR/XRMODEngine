...
{
    public class UnityFusionFieldInfo : FieldInfo
    {
        System.Reflection.FieldAttributes attr;
        UnityFusionType dType;
        ILType ilType;
        IType fieldType;
        bool isStatic;
        int fieldIdx;
        ...
        public UnityFusionFieldInfo(FieldDefinition def, UnityFusionType declaredType, bool isStatic, int fieldIdx)
        {
            definition = def;
            this.name = def.Name;
            dType = declaredType;
        ...
        public UnityFusionFieldInfo(FieldDefinition def, UnityFusionType declaredType, int fieldIdx, IType fieldType)
        {
            definition = def;
            this.name = def.Name;
            dType = declaredType;
