...
using UnityFusion.Runtime.Intepreter.RegisterVM;
using UnityFusion.Runtime.Debugger;
using UnityFusion.CLR.TypeSystem;
using UnityFusion.Reflection;
namespace UnityFusion.CLR.Method
{
    public sealed class ILMethod : IMethod
    {
        ...
        int eventFieldIndex;
        bool jitPending;
        UnityFusionMethodInfo refletionMethodInfo;
        UnityFusionConstructorInfo reflectionCtorInfo;
        ...
        public UnityFusion.Runtime.Enviorment.AppDomain AppDomain { get { return appdomain; } }
        ...
        public MethodInfo ReflectionMethodInfo
        {
            get
            {
                ...
                if (refletionMethodInfo == null)
                    refletionMethodInfo = new UnityFusionMethodInfo(this);
        ...
        public ConstructorInfo ReflectionConstructorInfo
        {
            get
            {
                ...
                if (reflectionCtorInfo == null)
                    reflectionCtorInfo = new UnityFusionConstructorInfo(this);
        ...
        public ILMethod(MethodDefinition def, ILType type, UnityFusion.Runtime.Enviorment.AppDomain domain, int flags)
        {
            this.def = def;
            declaringType = type;
            this.jitFlags = flags;
            ...
            jitImmediately = (jitFlags & UnityFusionJITFlags.JITImmediately) == UnityFusionJITFlags.JITImmediately;
            jitOnDemand = (jitFlags & UnityFusionJITFlags.JITOnDemand) == UnityFusionJITFlags.JITOnDemand;
                    ...
                    case OpCodeEnum.Callvirt:
                        {
                            ...
                            else if (m is CLRMethod)
                            {
                                ...
                                UnityFusion.CLR.Utils.Extensions.GetTypeFlags(clrm.DeclearingType.TypeForCLR);
                            }
                        }
                        break;
        ...
        private void Prewarm(HashSet<ILMethod> alreadyPrewarmed)
        {
            ...
            for (int i = 0; i < LocalVariableCount; i++)
            {
                ...
                if (t is CLRType)
                {
                    ...
                    UnityFusion.CLR.Utils.Extensions.GetTypeFlags(ct.TypeForCLR);
                }
            }
