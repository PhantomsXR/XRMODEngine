...
namespace UnityFusion.CLR.Method
{
    public sealed class CLRMethod : IMethod
    {
        ...
        internal CLRMethod(MethodInfo def, CLRType type, UnityFusion.Runtime.Enviorment.AppDomain domain)
        {
            this.def = def;
            declaringType = type;
        ...
        internal CLRMethod(ConstructorInfo def, CLRType type, UnityFusion.Runtime.Enviorment.AppDomain domain)
        {
            this.cDef = def;
            declaringType = type;
            this.appdomain = domain;
        ...
        public unsafe object Invoke(Runtime.Intepreter.ILIntepreter intepreter, StackObject* esp, AutoList mStack, bool isNewObj = false)
        {
            ...
            else
            {
                ...
                if (!def.IsStatic)
                {
                    ...
                    if (!(instance is Reflection.UnityFusionWrapperType))
        ...
        public IMethod MakeGenericMethod(IType[] genericArguments)
        {
            ...
            MethodInfo t = null;
#if UNITY_EDITOR || (DEBUG && !DISABLE_UNITYFUSION_DEBUG)
            try
            {
#endif
