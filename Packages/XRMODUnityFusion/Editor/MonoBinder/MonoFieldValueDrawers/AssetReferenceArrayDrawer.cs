...
{
    public class AssetReferenceArrayDrawer : IMonoFieldValueDraw
    {
        ...
        {
            var tmp_AssetReferenceArrayProperty = _property.FindPropertyRelative("Value");
            EditorGUI.PropertyField(_fieldRect, tmp_AssetReferenceArrayProperty,
                new GUIContent("Asset Reference Array"));
        }
    }
}