...
{   
    public class TargetKeyBaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(Goap.Runtime.TargetKeyBase);
            }
        }
        ...
        public class Adapter : Goap.Runtime.TargetKeyBase, CrossBindingAdaptorType
        {
