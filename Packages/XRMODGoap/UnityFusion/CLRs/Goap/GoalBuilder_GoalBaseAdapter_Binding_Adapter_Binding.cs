...
{
    unsafe class GoalBuilder_GoalBaseAdapter_Binding_Adapter_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Goap.Runtime.GoalBuilder<GoalBaseAdapter.Adapter>);
            ...
            args = new Type[] {typeof(WorldKeyBaseAdapter.Adapter)};
            ...
            CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Single @_baseCost = *(float*)&ptr_of_this_method->Value;
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Goap.Runtime.GoalBuilder instance_of_this_method =
                (Goap.Runtime.GoalBuilder) typeof(Goap.Runtime.GoalBuilder).CheckCLRTypes(
                    StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags) 0);
            __intp.Free(ptr_of_this_method);
            var result_of_this_method =
                instance_of_this_method.SetBaseCost(@_baseCost);
