...
{
    unsafe class UnityFusion_CLRBinding_Adapter_ITargetAdapter_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityFusion.CLRBinding.Adapter.ITargetAdapter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityFusion.CLRBinding.Adapter.ITargetAdapter());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityFusion.CLRBinding.Adapter.ITargetAdapter[s]);
        ...
        static StackObject* get_BaseCLRType_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityFusion.CLRBinding.Adapter.ITargetAdapter instance_of_this_method = (UnityFusion.CLRBinding.Adapter.ITargetAdapter)typeof(UnityFusion.CLRBinding.Adapter.ITargetAdapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityFusion.CLRBinding.Adapter.ITargetAdapter();
