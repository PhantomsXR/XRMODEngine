...
{
    unsafe class UnityFusion_CLRBinding_Adapter_IActionDataAdapter_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityFusion.CLRBinding.Adapter.IActionDataAdapter);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityFusion.CLRBinding.Adapter.IActionDataAdapter());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityFusion.CLRBinding.Adapter.IActionDataAdapter[s]);
        ...
        static StackObject* get_BaseCLRType_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityFusion.CLRBinding.Adapter.IActionDataAdapter instance_of_this_method = (UnityFusion.CLRBinding.Adapter.IActionDataAdapter)typeof(UnityFusion.CLRBinding.Adapter.IActionDataAdapter).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityFusion.CLRBinding.Adapter.IActionDataAdapter();
