...
namespace Goap.Runtime
{
    ...
    public class ActionBuilder
    {
        ...
        protected void ValidateProperties(IActionProperties properties)
        {
            ...
            if (actionPropsType == TypeReSolveHelper.ResolveType(properties))
                return;
        ...
        public static ActionBuilder Create(Type _type, WorldKeyBuilder worldKeyBuilder,
            TargetKeyBuilder targetKeyBuilder)
        {
            return new ActionBuilder(_type, worldKeyBuilder, targetKeyBuilder);
        }


        public ActionBuilder AddEffect(Type _worldKeyType, EffectType _type)
        {
            this.effects.Add(new Effect
            {
                WorldKey = this.worldKeyBuilder.GetKey(_worldKeyType),
                Increase = _type == EffectType.Increase,
            });
        ...
        public ActionBuilder SetTarget(Type _targetKeyType)
        {
            this.config.Target = this.targetKeyBuilder.GetKey(_targetKeyType);
            return this;
        }
        ...
        public ActionBuilder AddCondition(Type _worldKeyType, Comparison comparison, int amount)
        {
            this.conditions.Add(new Condition
            {
                WorldKey = this.worldKeyBuilder.GetKey(_worldKeyType),
        ...
        public ActionBuilder SetValidateTarget(bool validate)
        {
            this.config.ValidateTarget = validate;
            return this;
        }
        ...
        public ActionBuilder SetCallback(Action<object> callback)
        {
