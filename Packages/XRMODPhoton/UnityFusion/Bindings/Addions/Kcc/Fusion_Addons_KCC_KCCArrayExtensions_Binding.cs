...
{
    unsafe class Fusion_Addons_KCC_KCCArrayExtensions_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.Addons.KCC.KCCArrayExtensions);
        ...
        static StackObject* Clear_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Addons.KCC.KCCArrayExtensions.Clear(@array);
