...
namespace Phantom.XRMOD.XRMODInput.Runtime
{
    ...
    {
        [SerializeField] private bool m_Reversal;
        ...
        void Update()
        {
            if (m_StickInput != null)
            {
                ...
                m_ThumbstickTransform.localRotation = m_Reversal
            ...
            if (m_TriggerInput != null)
            {
                ...
                m_TriggerTransform.localRotation = Quaternion.Euler(
                    Mathf.Lerp(m_TriggerXAxisRotationRange.x,
                        m_Reversal ? -m_TriggerXAxisRotationRange.y : m_TriggerXAxisRotationRange.y, triggerVal), 0f,
                    0f);
            }
            ...
            if (m_GripInput != null)
            {
                ...
                m_GripTransform.localPosition = new Vector3(
                    Mathf.Lerp(m_GripRightRange.x, m_Reversal ? -m_GripRightRange.y : m_GripRightRange.y, gripVal),
