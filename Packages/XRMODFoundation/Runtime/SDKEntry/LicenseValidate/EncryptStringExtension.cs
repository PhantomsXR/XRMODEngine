...
namespace Phantom.XRMOD.SDKEntry.Runtime
{
    public static class EncryptStringExtension
    {
        ...
        public static string Encrypt(this string _text)
        {
            ...
            var plainTextBytes = Encoding.UTF8.GetBytes(_text);
            using (var password = new Rfc2898DeriveBytes(CONST_SECRET_KEY, saltStringBytes, DerivationIterations))
            {
        ...
        public static string Decrypt(this string _text)
        {
            ...
            var cipherTextBytesWithSaltAndIv = Convert.FromBase64String(_text);
