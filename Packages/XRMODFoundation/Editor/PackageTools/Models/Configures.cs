...
namespace Phantom.XRMOD.XRMODPackageTools.Editor
{
    ...
    {
        public SDKDeviceType SDKDeviceType;
        public float ARWorldScale = 1.0f;
        public string Version = "2.0.0";
        public AlgorithmType Algorithm = AlgorithmType.None;
        public bool AlgorithmAutoStart = true;

        public PlaneDetectionMode PlaneDetectionMode = PlaneDetectionMode.None;
    ...
    public enum AlgorithmType
    {
        ...
        Fixed = 3,
#endif
#if HANDHELD_ARMODULE_INSTALL || VISIONOS_INSTALL || ROKID_INSTALL || XREAL_INSTALL
        ImageTracker = 4,
#endif
#if HANDHELD_ARMODULE_INSTALL || ROKID_INSTALL || QUEST_INSTALL
        Immersal = 5,
#endif
