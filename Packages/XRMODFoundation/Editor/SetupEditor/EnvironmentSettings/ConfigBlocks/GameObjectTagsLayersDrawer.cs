...
{
    public class GameObjectTagsLayersDrawer : AbstractDrawer, IFixer
    {
        ...
        {
            return DrawUtility.CreateSettingStateUI("Tags & Layers", _CONST_TAGS_AND_LAYERS_HELP, () => CheckTagsAndLayers(),
                CheckedTexture,
                ErrorTexture,
                FixTagsAndLayers);
        }
