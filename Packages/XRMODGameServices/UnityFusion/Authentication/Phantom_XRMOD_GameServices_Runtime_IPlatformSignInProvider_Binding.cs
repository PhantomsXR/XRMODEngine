...
{
    unsafe class Phantom_XRMOD_GameServices_Runtime_IPlatformSignInProvider_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.GameServices.Runtime.IPlatformSignInProvider);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.GameServices.Runtime.IPlatformSignInProvider[s]);
        ...
        static StackObject* Initialize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Phantom.XRMOD.GameServices.Runtime.IPlatformSignInProvider instance_of_this_method = (Phantom.XRMOD.GameServices.Runtime.IPlatformSignInProvider)typeof(Phantom.XRMOD.GameServices.Runtime.IPlatformSignInProvider).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
