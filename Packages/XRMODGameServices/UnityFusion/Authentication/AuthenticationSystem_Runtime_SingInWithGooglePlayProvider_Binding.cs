...
{
    unsafe class AuthenticationSystem_Runtime_SingInWithGooglePlayProvider_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(AuthenticationModule.Runtime.SingInWithGooglePlayProvider);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new AuthenticationModule.Runtime.SingInWithGooglePlayProvider());
            app.RegisterCLRCreateArrayInstance(type, s => new AuthenticationModule.Runtime.SingInWithGooglePlayProvider[s]);
        ...
        static StackObject* Initialize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            AuthenticationModule.Runtime.SingInWithGooglePlayProvider instance_of_this_method = (AuthenticationModule.Runtime.SingInWithGooglePlayProvider)typeof(AuthenticationModule.Runtime.SingInWithGooglePlayProvider).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new AuthenticationModule.Runtime.SingInWithGooglePlayProvider();
