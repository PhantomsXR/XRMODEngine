...
namespace Phantom.XRMOD.UIFramework.Runtime
{
    public class Grabber : MonoBehaviour, IDragHandler
    {
        ...
        public void OnSelectEntered(SelectEnterEventArgs eventData)
        {
            ...
            interactor =
 eventData.interactorObject.transform.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor>();

            actionBasedController =
 (interactor as UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInputInteractor).xrController as ActionBasedController;
            ...
            radius =
 Vector3.Distance(new Vector3(windowTransform.position.x, 0, windowTransform.position.z), new Vector3(interactor.transform.position.x, 0, interactor.transform.position.z));
            additiveRotation = 0;
            ...
            windowAngleOnSelect =
 windowTransform.rotation.eulerAngles.y - Quaternion.LookRotation(targetPositon - interactorPosition).eulerAngles.y;
        }
