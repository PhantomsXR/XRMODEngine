...
namespace Phantom.XRMOD.XRMODPackageTools.Editor
{
    public class QualityBlock : AbstractBlock
    {
        ...
        public QualityBlock(Configures _property):base(_property)
        {
            qualityLevel =(QualityLevel)_property.QualityLevel;
        }

        public override Rect DrawBlock(Rect _area)
        {
            enabledQualityBlock = EditorGUILayout.BeginFoldoutHeaderGroup(enabledQualityBlock, ENABLE_QUALITY_BLOCK_MSG,null, ShowHeaderContextMenu);
