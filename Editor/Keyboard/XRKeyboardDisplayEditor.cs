...
namespace Phantom.XRMOD.XRMODInput.Editor.Keyboard
{
    ...
    /// </summary>
    [UnityEditor.CustomEditor(typeof(XRKeyboardDisplay), true), UnityEditor.CanEditMultipleObjects]
    public class XRKeyboardDisplayEditor : BaseInteractionEditor
    {
        /// <summary><see cref="UnityEditor.SerializedProperty"/> of the <see cref="SerializeField"/> backing <see cref="XRKeyboardDisplay.inputField"/>.</summary>
        ...
        {
            m_OnTextSubmitted.isExpanded = EditorGUILayout.Foldout(m_OnTextSubmitted.isExpanded,
                Contents.keyboardEvents, toggleOnLabelClick: true);
