...
{
    public class DataPropertyValueDrawer : IMonoFieldValueDraw
    {
        public bool CanDraw(MonoField.FieldTypeEnum _fieldType) => _fieldType == MonoField.FieldTypeEnum.DataProperty;

        public void Draw(SerializedProperty _property, Rect _fieldRect)
        {
            var tmp_StringProperty = _property.FindPropertyRelative("Value");
            EditorGUI.PropertyField(_fieldRect, tmp_StringProperty, new GUIContent("Data"));
        }
    }
}