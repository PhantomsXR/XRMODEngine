...
{
    public class QuaternionArrayValueDrawer : IMonoFieldValueDraw
    {
        ...
        {
            var tmp_QuaternionArrayProperty =
                _property.FindPropertyRelative(nameof(MonoField.FieldTypeEnum.QuaternionArray));
            DrawerUtils.MakeSureUnityObjectField(_fieldRect, ref tmp_QuaternionArrayProperty);
        }
    }
}