...
namespace Goap.Runtime
{
    ...
    public class TargetSensorBuilder
    {
        ...
        public static TargetSensorBuilder Create(Type _type, TargetKeyBuilder targetKeyBuilder)
        {
            return new TargetSensorBuilder(_type, targetKeyBuilder);
        }


        public TargetSensorBuilder SetTarget(Type _type)
        {
            this.config.Key = this.targetKeyBuilder.GetKey(_type);
            return this;
        }
    }
}