...
namespace UnityFusion.Runtime.Generated
{
    unsafe class System_Runtime_CompilerServices_AsyncTaskMethodBuilder_1_Boolean_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter), typeof(UnityFusion.CLRBinding.Adapter.AsyncStateMachineClassInheritanceAdaptor.AsyncStateMachineAdaptor)};
            if (genericMethods.TryGetValue("AwaitUnsafeOnCompleted", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter).MakeByRefType(), typeof(UnityFusion.CLRBinding.Adapter.AsyncStateMachineClassInheritanceAdaptor.AsyncStateMachineAdaptor).MakeByRefType()))
                    {
                        method = m.MakeGenericMethod(args);
        ...
        static StackObject* AwaitUnsafeOnCompleted_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter @awaiter = (System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter)typeof(System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 3);
            ptr_of_this_method = ILIntepreter.GetObjectAndResolveReference(ptr_of_this_method);
            System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Boolean> instance_of_this_method = (System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Boolean>)typeof(System.Runtime.CompilerServices.AsyncTaskMethodBuilder<System.Boolean>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);

            instance_of_this_method.AwaitUnsafeOnCompleted<System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter, UnityFusion.CLRBinding.Adapter.AsyncStateMachineClassInheritanceAdaptor.AsyncStateMachineAdaptor>(ref @awaiter, ref @stateMachine);
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as System.Runtime.CompilerServices.YieldAwaitable.YieldAwaiter[];
                        instance_of_arrayReference[ptr_of_this_method->ValueLow] = @awaiter;
                    }
                    break;
            }
