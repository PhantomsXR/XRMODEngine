...
{
    unsafe class System_Collections_Generic_Stack_1_Vector3_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Stack<UnityEngine.Vector3>);
            args = new Type[] { };
            ...
            app.RegisterCLRCreateDefaultInstance(type,
                () => new System.Collections.Generic.Stack<UnityEngine.Vector3>());
            app.RegisterCLRCreateArrayInstance(type, s => new System.Collections.Generic.Stack<UnityEngine.Vector3>[s]);
            ...
            CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Stack<UnityEngine.Vector3> instance_of_this_method =
                (System.Collections.Generic.Stack<UnityEngine.Vector3>)
                typeof(System.Collections.Generic.Stack<UnityEngine.Vector3>).CheckCLRTypes(
        ...
        static StackObject* Contains_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
            CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* CopyTo_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
            CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        // static StackObject* TrimExcess_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
        //     CLRMethod __method, bool isNewObj)
        // {
        //     UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        //     StackObject* ptr_of_this_method;
        ...
        static StackObject* Peek_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* Pop_8(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* Push_10(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* ToArray_11(ILIntepreter __intp, StackObject* __esp, AutoList __mStack,
            CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Vector3>();
            ...
            bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Vector3>(@capacity);
            ...
            bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityEngine.Vector3> @collection =
            ...
            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Vector3>(@collection);
