...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_Ray_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_origin_0);
            args = new Type[]{typeof(UnityEngine.Vector3)};
            method = type.GetMethod("set_direction", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_direction_1);
            args = new Type[]{};
            method = type.GetMethod("get_origin", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_origin_2);
            args = new Type[]{};
            method = type.GetMethod("get_direction", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_direction_3);
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref UnityEngine.Ray instance_of_this_method)
        {
        ...
        static StackObject* set_origin_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_direction_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_origin_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_direction_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
