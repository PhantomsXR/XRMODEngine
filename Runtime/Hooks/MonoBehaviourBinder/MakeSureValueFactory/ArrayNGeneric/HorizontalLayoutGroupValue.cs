...
{
    public class HorizontalLayoutGroupValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<HorizontalLayoutGroup>().ToList()
                    : convertedArray.Cast<HorizontalLayoutGroup>().ToArray());
            return true;
