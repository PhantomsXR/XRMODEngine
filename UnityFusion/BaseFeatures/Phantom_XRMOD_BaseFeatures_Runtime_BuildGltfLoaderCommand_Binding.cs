...
{
    unsafe class Phantom_XRMOD_BaseFeatures_Runtime_BuildGltfLoaderCommand_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.BaseFeatures.Runtime.BuildGltfLoaderCommand);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.BaseFeatures.Runtime.BuildGltfLoaderCommand());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.BaseFeatures.Runtime.BuildGltfLoaderCommand[s]);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.BaseFeatures.Runtime.BuildGltfLoaderCommand();
