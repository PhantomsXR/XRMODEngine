...
{
    unsafe class Goap_Runtime_WorldKeyBase_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Goap.Runtime.WorldKeyBase);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new Goap.Runtime.WorldKeyBase[s]);
        ...
        static StackObject* get_Name_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Goap.Runtime.WorldKeyBase instance_of_this_method = (Goap.Runtime.WorldKeyBase)typeof(Goap.Runtime.WorldKeyBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
