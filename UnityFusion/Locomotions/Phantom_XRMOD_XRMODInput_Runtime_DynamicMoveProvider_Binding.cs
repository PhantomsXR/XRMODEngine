...
{
    unsafe class Phantom_XRMOD_XRMODInput_Runtime_DynamicMoveProvider_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider.MovementDirection)};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider[s]);
        ...
        static StackObject* get_headTransform_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider instance_of_this_method = (Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider)typeof(Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_leftHandMovementDirection_7(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider.MovementDirection @value = (Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider.MovementDirection)typeof(Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider.MovementDirection).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.XRMODInput.Runtime.DynamicMoveProvider();
