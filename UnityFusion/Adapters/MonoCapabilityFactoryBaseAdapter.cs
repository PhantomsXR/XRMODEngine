...
{
    public class MonoCapabilityFactoryBaseAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType => typeof(MonoCapabilityFactoryBase);
        ...
        public class Adapter : MonoCapabilityFactoryBase,CrossBindingAdaptorType
        {
            ...
            readonly CrossBindingFunctionInfo<ICapabilityConfig> create = new("Create");

            public override ICapabilityConfig Create()
            {
                return create?.Invoke(this.instance);
            }
