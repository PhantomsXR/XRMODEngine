...
namespace ParrelSync
{
    ...
    public class ClonesManager
    {
        ...
        public static Project CreateCloneFromPath(string sourceProjectPath)
        {
            ...
            ClonesManager.LinkFolders(sourceProject.libraryPath, cloneProject.libraryPath);
            ...
            ClonesManager.LinkFolders(sourceProject.serverDataPath, cloneProject.serverDataPath);
