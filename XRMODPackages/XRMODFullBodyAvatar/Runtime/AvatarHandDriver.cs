...
{
    public class AvatarHandDriver : XRHandSkeletonDriver
    {
        [SerializeField] private Transform handBone;

        internal static readonly Dictionary<XRHandJointID, string> _JOINT_ID_BONE_PATH_MAP_LEFT = new()
        {
        ...
        internal static readonly Dictionary<XRHandJointID, string> _JOINT_ID_BONE_PATH_MAP_RIGHT = new()
        {
        ...
        internal void SetBoneReferences()
        {
            ...
            var handMap = handBone.name.Contains("LeftHand")
                ? _JOINT_ID_BONE_PATH_MAP_LEFT
                : _JOINT_ID_BONE_PATH_MAP_RIGHT;
