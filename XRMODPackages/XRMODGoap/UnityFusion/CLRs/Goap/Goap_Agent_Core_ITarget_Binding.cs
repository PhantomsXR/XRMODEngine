...
{
    unsafe class Goap_Agent_Core_ITarget_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Goap.Agent.Core.ITarget);
            args = new Type[]{};
        ...
        static StackObject* get_Position_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Goap.Agent.Core.ITarget instance_of_this_method = (Goap.Agent.Core.ITarget)typeof(Goap.Agent.Core.ITarget).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
