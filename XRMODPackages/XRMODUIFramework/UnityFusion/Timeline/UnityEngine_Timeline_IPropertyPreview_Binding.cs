...
{
    unsafe class UnityEngine_Timeline_IPropertyPreview_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Timeline.IPropertyPreview);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Timeline.IPropertyPreview[s]);
        ...
        static StackObject* GatherProperties_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Timeline.IPropertyPreview instance_of_this_method = (UnityEngine.Timeline.IPropertyPreview)typeof(UnityEngine.Timeline.IPropertyPreview).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
