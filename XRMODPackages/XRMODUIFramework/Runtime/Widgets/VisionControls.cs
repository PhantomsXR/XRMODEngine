...
namespace Phantom.XRMOD.UIFramework.Runtime
{
    public static class VisionControls
    {
        ...
        {
#if UNITY_EDITOR
            UnityEditor.Animations.AnimatorController.SetAnimatorController(target,
                controller as UnityEditor.Animations.AnimatorController);
#else
        ...
        public static GameObject CreateTextButton(Resources resources, float width, float height, float fontSize)
            //float multiplier
        {
            GameObject root = CreateUIElementRoot("Button - Text", new Vector2(width, height), typeof(Image),
                typeof(Button), typeof(Animator));
            ...
            SetupImage(background, resources.buttonBackground, s_WindowElementColor, resources.lightElementMaterial,
                true, padding, true, Image.Type.Sliced, true, resources.buttonBackground.texture.height / height);

            SetupWindowElement(root, alphaBackground, resources);

            // Highlight
            Image highlightImage = highlight.GetComponent<Image>();
            SetupImage(highlightImage, resources.buttonHighlight, s_WhiteTransparent, null, false, Vector4.zero, true,
                Image.Type.Sliced, true, resources.buttonHighlight.texture.height / height);
            ...
            SetupTextMeshProUGUI(textTMP, "Label", resources.fontSemibold, fontSize, Color.white,
                HorizontalAlignmentOptions.Center, VerticalAlignmentOptions.Middle, false, TextOverflowModes.Ellipsis);
        ...
        public static GameObject CreateTextButtonNoPlatter(Resources resources, float width, float height,
            float fontSize)
        {
        ...
        {
            GameObject root = CreateUIElementRoot("Button - Text+Symbol", new Vector2(width, height), typeof(Image),
                typeof(Button), typeof(Animator));
            ...
            TextMeshProUGUI textTMP = text.GetComponent<TextMeshProUGUI>();
            SetupTextMeshProUGUI(textTMP, "Label", resources.fontSemibold, fontSize, Color.white,
                HorizontalAlignmentOptions.Left, VerticalAlignmentOptions.Middle, false, TextOverflowModes.Ellipsis);
            ...
            SetupRect(symbolRect, new Vector2(0, 0.5f), new Vector2(0, 0.5f), new Vector2(height, height),
        ...
        public static GameObject CreateTextSymbolButtonNoPlatter(Resources resources, float width, float height,
            float fontSize)
        {
        ...
        {
            GameObject root = CreateUIElementRoot("Button - Text Rounded Rect", new Vector2(width, height),
                typeof(Image), typeof(Button), typeof(Animator));
            ...
            SetupImage(background, resources.roundedRectBackground, s_WindowElementColor,
                resources.lightElementMaterial, true, padding, true, Image.Type.Sliced, true,
                resources.roundedRectBackground.texture.height / height);

            SetupWindowElement(root, alphaBackground, resources);

            // Highlight
            Image highlightImage = highlight.GetComponent<Image>();
            SetupImage(highlightImage, resources.roundedRectHighlight, s_WhiteTransparent, null, false, Vector4.zero,
                true, Image.Type.Sliced, true, resources.roundedRectHighlight.texture.height / height);
        ...
        public static GameObject CreateRoundedRectButtonNoPlatter(Resources resources, float width, float height,
            float fontSize)
        {
        ...
        {
            GameObject root = CreateUIElementRoot("Button - Symbol", new Vector2(size, size), typeof(Image),
                typeof(Button), typeof(Animator));
            ...
            SetupImage(background, resources.buttonBackground, s_WindowElementColor, resources.lightElementMaterial,
                true, padding, true, Image.Type.Sliced, true, resources.buttonBackground.texture.height / size);

            SetupWindowElement(root, alphaBackground, resources);

            // Highlight
            Image highlightImage = highlight.GetComponent<Image>();
            SetupImage(highlightImage, resources.symbolHighlight, s_WhiteTransparent, null, false, Vector4.zero, true,
                Image.Type.Sliced, true, resources.symbolHighlight.texture.height / size);
        ...
        {
            GameObject root = CreateUIElementRoot("Mini Slider", new Vector2(288f, height), typeof(Slider),
                typeof(Animator));
            ...
            SetupImage(backgroundImage, resources.sliderElement, s_WindowElementColor, resources.darkElementMaterial,
                true, padding, true, Image.Type.Sliced, true, resources.sliderElement.texture.height / height);
            ...
            SetupImage(maskImage, resources.sliderElement, s_WindowElementColor, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Sliced, true, resources.sliderElement.texture.height / height);
            ...
            SetupImage(fillImage, resources.sliderElement, new Vector4(1, 1, 1, 0.6f), null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Sliced, true,
                resources.sliderElement.texture.height / height);
            ...
            SetupImage(shadowImage, resources.miniSliderShadow, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Simple, true, 0);

            RectTransform shadowRect = shadow.GetComponent<RectTransform>();
            SetupRect(shadowRect, new Vector2(1, 0.5f), new Vector2(1, 0.5f), new Vector2(21, 20),
                new Vector2(-1.55f, 0));

            //Highlight
            Image highlightImage = highlight.GetComponent<Image>();
            SetupImage(highlightImage, resources.sliderHighlight, s_WhiteTransparent, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Simple, true, 0);
            ...
            SetupImage(embossImage, resources.miniSliderEmboss, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Sliced, true,
                resources.miniSliderEmboss.texture.height / height);
            ...
            SetupImage(handleImage, resources.sliderElement, s_WhiteTransparent, null, true, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
            ...
            SetupImage(glowImage, resources.miniSliderGlow, s_WhiteTransparent, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
        ...
        {
            GameObject root = CreateUIElementRoot("Small Slider", new Vector2(288f, height), typeof(Slider),
                typeof(Animator));
            ...
            // Shadow
            Image shadowImage = shadow.GetComponent<Image>();
            SetupImage(shadowImage, resources.smallSliderShadow, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Simple, true, 0);

            RectTransform shadowRect = shadow.GetComponent<RectTransform>();
            SetupRect(shadowRect, new Vector2(1, 0.5f), new Vector2(1, 0.5f), new Vector2(25, 24),
                new Vector2(-3.33f, 0));
            ...
            // Emboss
            Image embossImage = emboss.GetComponent<Image>();
            SetupImage(embossImage, resources.smallSliderEmboss, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Sliced, true,
                resources.smallSliderEmboss.texture.height / height);
            ...
            // Glow
            Image glowImage = glow.GetComponent<Image>();
            SetupImage(glowImage, resources.smallSliderGlow, s_WhiteTransparent, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
        ...
        {
            GameObject root = CreateUIElementRoot("Regular Slider", new Vector2(288f, height), typeof(Slider),
                typeof(Animator));
            ...
            // Shadow
            Image shadowImage = shadow.GetComponent<Image>();
            SetupImage(shadowImage, resources.regularSliderShadow, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Simple, true, 0);

            RectTransform shadowRect = shadow.GetComponent<RectTransform>();
            SetupRect(shadowRect, new Vector2(1, 0.5f), new Vector2(1, 0.5f), new Vector2(37, 36),
                new Vector2(-9.53f, 0));
            ...
            // Symbol
            Image symbolImage = symbol.GetComponent<Image>();
            SetupImage(symbolImage, resources.symbol, Color.black, null, false, new Vector4(0, 0, 0, 0), true,
                Image.Type.Simple, true, 0);

            RectTransform symbolRect = symbol.GetComponent<RectTransform>();
            SetupRect(symbolRect, new Vector2(0f, 0.5f), new Vector2(0f, 0.5f), new Vector2(height, height),
                new Vector2(height / 2, 0));

            // Emboss
            Image embossImage = emboss.GetComponent<Image>();
            SetupImage(embossImage, resources.regularSliderEmboss, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Sliced, true,
                resources.regularSliderEmboss.texture.height / height);
            ...
            // Handle
            Image handleImage = handle.GetComponent<Image>();
            SetupImage(handleImage, resources.sliderElement, s_WhiteTransparent, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
            ...
            // Glow
            Image glowImage = glow.GetComponent<Image>();
            SetupImage(glowImage, resources.regularSliderGlow, s_WhiteTransparent, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
        ...
        {
            GameObject root = CreateUIElementRoot("Large Slider", new Vector2(288f, height), typeof(Slider),
                typeof(Animator));
            ...
            // Shadow
            Image shadowImage = shadow.GetComponent<Image>();
            SetupImage(shadowImage, resources.largeSliderShadow, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Simple, true, 0);

            RectTransform shadowRect = shadow.GetComponent<RectTransform>();
            SetupRect(shadowRect, new Vector2(1, 0.5f), new Vector2(1, 0.5f), new Vector2(53, 52),
                new Vector2(-17.5f, 0));
            ...
            // Emboss
            Image embossImage = emboss.GetComponent<Image>();
            SetupImage(embossImage, resources.largeSliderEmboss, s_WindowElementColor, null, false,
                new Vector4(0, 0, 0, 0), true, Image.Type.Sliced, true,
                resources.largeSliderEmboss.texture.height / height);
            ...
            // Glow
            Image glowImage = glow.GetComponent<Image>();
            SetupImage(glowImage, resources.largeSliderGlow, s_WhiteTransparent, null, false, new Vector4(0, 0, 0, 0),
                true, Image.Type.Simple, true, 0);
        ...
        {
            GameObject root = CreateUIElementRoot("Toggle", new Vector2(56f, 32f), typeof(Toggle), typeof(Animator),
                typeof(ToggleAnimation));
        ...
        {
            GameObject root = CreateUIElementRoot("Dropdown", new Vector2(120, 44), typeof(Image), typeof(TMP_Dropdown),
                typeof(Animator));
            ...
            ListElementImageBase itemLE = item.AddComponent<ListElementImageBase>();
            itemLE.SetReferences(itemBackgroundImage, resources.singleListElement, resources.firstListElement,
                resources.middleListElement, resources.lastListElement);
        ...
        {
            GameObject root = CreateUIElementRoot("InputField", new Vector2(305, 44), typeof(Image),
                typeof(TMP_InputField), typeof(Animator));
        ...
        {
            GameObject root = CreateUIElementRoot("Toolbar", new Vector2(68, 68), typeof(Image),
        ...
        {
            GameObject root = CreateUIElementRoot("Alert", new Vector2(44, 44), typeof(Image),
                typeof(VerticalLayoutGroup), typeof(ContentSizeFitter));

            GameObject appIcon = CreateUIObject("App Icon", root, typeof(Image));
            GameObject textBlock =
                CreateUIObject("Text Block", root, typeof(VerticalLayoutGroup), typeof(ContentSizeFitter));
        ...
        {
            GameObject root = CreateUIElementRoot("Toggle", new Vector2(44f, 44f), typeof(Image), typeof(Toggle),
                typeof(Animator), typeof(ToggleAnimation));
        ...
        {
            GameObject root = CreateUIElementRoot("Tabbar", new Vector2(68, 120), typeof(VerticalLayoutGroup),
        ...
        {
            GameObject root = CreateUIElementRoot("Windows Stacker", new Vector2(1306f, 734f), typeof(RectTransform),
                typeof(WindowsStacker));
        ...
        public static GameObject CreateWindowControls(Resources resources)
        {
            ...
            GameObject root = CreateUIElementRoot("Window Controls", new Vector2(174, 14), typeof(RectTransform),
                typeof(Animator));
            GameObject closeButtonWindow = CreateUIObject("Close Button Window", root, typeof(Image), typeof(Button),
                typeof(Animator));
            GameObject grabberObjectWindow =
                CreateUIObject("Grabber Window", root, typeof(Image), typeof(Button), typeof(Animator));
            GameObject closeButton = CreateUIObject("Close Button", closeButtonWindow, typeof(Image));
            GameObject closeButtonAlphaBackground =
                CreateUIObject("Alpha Background", closeButtonWindow, typeof(Image));
            GameObject crossIcon = CreateUIObject("Cross Icon", closeButtonWindow, typeof(Image));
            GameObject grabberObject = CreateUIObject("Grabber", grabberObjectWindow, typeof(Image),
                typeof(BoxCollider), typeof(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable),
                typeof(Grabber));
        ...
        {
            GameObject root = CreateUIElementRoot("Segmented Control", new Vector2(188, 44), typeof(Image),
                typeof(HorizontalLayoutGroup), typeof(ToggleGroup));

            GameObject alphaBackground = CreateUIObject("Alpha Background", root, typeof(Image));

            Image segmentedControlImage = root.GetComponent<Image>();
            SetupImage(segmentedControlImage, resources.buttonBackground, s_WindowElementColor,
                resources.darkElementMaterial, false, Vector4.zero, true, Image.Type.Sliced, true, 4);

            HorizontalLayoutGroup segmentedControlHorizontalLayoutGroup = root.GetComponent<HorizontalLayoutGroup>();
            SetupLayoutGroup(segmentedControlHorizontalLayoutGroup, new RectOffset(4, 4, 4, 4), 4,
                TextAnchor.MiddleCenter, true, true, false, false, true, true);
            ...
            for (int i = 0; i < 2; i++)
            {
                GameObject toggleObject = CreateUIObject("Toggle", root, typeof(Image), typeof(Toggle),
                    typeof(Animator), typeof(ToggleAnimation));
                ...
                SetupImage(toggleImage, resources.buttonBackground, s_WindowElementColor,
                    resources.lightElementWithFrameMaterial, true, Vector4.zero, true, Image.Type.Sliced, true,
                    4.888889f);

                Toggle toggle = toggleObject.GetComponent<Toggle>();
                SetupToggle(toggle, Selectable.Transition.Animation, Navigation.Mode.None, i == 0, toggleImage,
                    segmentedControlToggleGroup);
                ...
                Image highlightImage = highlight.GetComponent<Image>();
                SetupImage(highlightImage, resources.segmentedControlHighlight, new Color(1, 1, 1, 0), null, true,
                    Vector4.zero, true, Image.Type.Sliced, true, 4f);
                ...
                SetupLayoutGroup(titleHorizontalLayoutGroup, new RectOffset(0, 0, 0, 0), 0, TextAnchor.MiddleCenter,
                ...
                TextMeshProUGUI textTMP = text.GetComponent<TextMeshProUGUI>();
                SetupTextMeshProUGUI(textTMP, "Label", resources.fontSemibold, 15, s_TextColorPrimary,
                    HorizontalAlignmentOptions.Center, VerticalAlignmentOptions.Middle, false,
        ...
        public static GameObject CreateCompletedList(Resources resources)
        {
            ...
            SetupLayoutGroup(completedListRectVerticalLayoutGroup, new RectOffset(12, 12, 0, 0), 0,
                TextAnchor.UpperLeft, true, false, false, false, true, true);
            ...
            SetupTextMeshProUGUI(headerTextTMP, "Header Text", resources.fontBold, 19, s_TextColorPrimary,
                HorizontalAlignmentOptions.Left, VerticalAlignmentOptions.Top, false, TextOverflowModes.Ellipsis);
            ...
            SetupTextMeshProUGUI(footerTextTMP, "Footer Text", resources.fontMedium, 13, s_TextColorSecondary,
                HorizontalAlignmentOptions.Left, VerticalAlignmentOptions.Top, false, TextOverflowModes.Ellipsis);
        ...
        {
            GameObject root = CreateUIElementRoot("List Element", new Vector2(460f, 60f), typeof(Image), typeof(Button),
                typeof(Animator));
            ...
            Image background = root.GetComponent<Image>();
            SetupImage(background, resources.roundedRectBackground, s_WindowElementColor, resources.darkElementMaterial,
                true, Vector4.zero, true, Image.Type.Sliced, true, 4);

            ListElementImageBase tmp_ListElementImageBase = root.AddComponent<ListElementImageBase>();
            tmp_ListElementImageBase.SetReferences(background, resources.singleListElement, resources.firstListElement,
                resources.middleListElement, resources.lastListElement,
                new List<Image>
                {
            ...
            // Text
            TextMeshProUGUI textTMP = text.GetComponent<TextMeshProUGUI>();
            SetupTextMeshProUGUI(textTMP, "Title", resources.fontMedium, 17, s_TextColorPrimary,
                HorizontalAlignmentOptions.Left, VerticalAlignmentOptions.Middle, false, TextOverflowModes.Ellipsis);
            ...
            SetupRect(arrowRect, new Vector2(1, 0.5f), new Vector2(1, 0.5f), new Vector2(11f, 44f),
                new Vector2(-25.5f, 0));
        ...
        {
            GameObject root = CreateUIElementRoot("Volume", new Vector2(64, 64), typeof(Image), typeof(Button),
                typeof(Animator), typeof(SpriteNumberSwitcher));
            ...
            symbolSwitcher.Sprites = new Sprite[]
                {resources.speakerSlash, resources.speaker1, resources.speaker2, resources.speaker3};
        ...
        public static GameObject CreateWindowResizer(Resources resources)
        {
            ...
            GameObject interactable = CreateUIObject("Interactable", root, typeof(Image), typeof(Resizer),
                typeof(UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable), typeof(BoxCollider));

            // Position Pivot
            RectTransform positionPivotRect = positionPivot.GetComponent<RectTransform>();
            SetupRect(positionPivotRect, new Vector2(1, 0), new Vector2(1, 0), new Vector2(75, 75),
                new Vector2(-75, 75));
        ...
        private static void SetupWindowElement(GameObject background, GameObject alphaBackground, Resources resources)
        {
            ...
            SetupImage(alphaBackgroundImage, backgroundImage.sprite, new Color(1, 1, 1, 0),
                resources.alphaBackgroundMaterial, false, backgroundImage.raycastPadding,
                backgroundImage.maskable, backgroundImage.type, backgroundImage.fillCenter,
                backgroundImage.pixelsPerUnitMultiplier);
        }

        public static void SetupRect(RectTransform rectTransform, Vector2 anchorMin, Vector2 anchorMax,
        ...
        public static void SetupImage(Image image, Sprite sprite, Color color, Material material, bool raycastTarget,
            Vector4 raycastPadding, bool maskable,
        ...
        public static void SetupTextMeshProUGUI(TextMeshProUGUI textMeshProUGUI, string text, TMP_FontAsset font,
            float fontSize, Color color, HorizontalAlignmentOptions horizontalAlignment,
        ...
        public static void SetupToggle(Toggle toggle, Selectable.Transition transition, Navigation.Mode mode, bool isOn,
            Image graphic, ToggleGroup toggleGroup)
        {
        ...
        public static void SetupLayoutGroup(HorizontalOrVerticalLayoutGroup horizontalLayoutGroup, RectOffset padding,
            float spacing, TextAnchor childAligment,
            bool childControlWidth, bool childControlHeight, bool childScaleWidth, bool childScaleHeight,
            bool childForceExpandWidth, bool childForceExpandHeight)
        {
