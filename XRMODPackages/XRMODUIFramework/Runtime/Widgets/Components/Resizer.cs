...
namespace Phantom.XRMOD.UIFramework.Runtime
{
 ...
 scaleOnSelectEntered * Vector3.Distance(objectToTransform.transform.position, eventData.position) / distanceOnSelectEntered;
        }
        #endregion
 ...
 eventData.interactorObject.transform.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactors.XRBaseInteractor>();
        ...
        private void Update()
        {
            ...
            {
                objectToTransform.transform.localScale =
 scaleOnSelectEntered * Vector3.Distance(objectToTransform.transform.position, hit.point) / distanceOnSelectEntered;
            }
        }
        #endregion
