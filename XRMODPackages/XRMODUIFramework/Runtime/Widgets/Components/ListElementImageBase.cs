...
{
    [ExecuteInEditMode]
    public class ListElementImageBase : UIBehaviour
    {
        ...
        private void UpdateElementSprite()
        {
            ...
            bool previousChildIsListElement = previousChild != null && previousChild.TryGetComponent<ListElementImageBase>(out _);
            bool nextChildIsListElement = nextChild != null && nextChild.TryGetComponent<ListElementImageBase>(out _);
