...
{
    unsafe class LoadObjectArgs_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs[s]);
        ...
        {
            return ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).ProjectName;
        }

        static StackObject* CopyToStack_ProjectName_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).ProjectName;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_ProjectName_0(ref object o, object v)
        {
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).ProjectName = (System.String)v;
        }
        ...
        static StackObject* AssignFromStack_ProjectName_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).ProjectName = @ProjectName;
            return ptr_of_this_method;
        }

        static object get_LoadObjectName_1(ref object o)
        {
            return ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectName;
        }

        static StackObject* CopyToStack_LoadObjectName_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectName;
        ...
        {
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectName = (System.Collections.Generic.List<System.String>)v;
        }
        ...
        static StackObject* AssignFromStack_LoadObjectName_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectName = @LoadObjectName;
            return ptr_of_this_method;
        }

        static object get_LoadObjectType_2(ref object o)
        {
            return ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectType;
        }

        static StackObject* CopyToStack_LoadObjectType_2(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectType;
            object obj_result_of_this_method = result_of_this_method;
            if(obj_result_of_this_method is CrossBindingAdaptorType)
            {    
                return ILIntepreter.PushObject(__ret, __mStack, ((CrossBindingAdaptorType)obj_result_of_this_method).ILInstance);
        ...
        {
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectType = (System.Type)v;
        }
        ...
        static StackObject* AssignFromStack_LoadObjectType_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs)o).LoadObjectType = @LoadObjectType;
            return ptr_of_this_method;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.ActionNotification.Runtime.LoadObjectArgs();
