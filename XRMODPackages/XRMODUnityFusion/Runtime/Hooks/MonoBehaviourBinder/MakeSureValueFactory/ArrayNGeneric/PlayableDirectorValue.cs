...
{
    public class PlayableDirectorValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<PlayableDirector>().ToList()
                    : convertedArray.Cast<PlayableDirector>().ToArray());
            return true;
