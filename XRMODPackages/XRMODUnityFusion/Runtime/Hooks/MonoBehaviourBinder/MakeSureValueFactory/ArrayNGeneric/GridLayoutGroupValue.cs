...
{
    public class GridLayoutGroupValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<GridLayoutGroup>().ToList()
                    : convertedArray.Cast<GridLayoutGroup>().ToArray());
            return true;
