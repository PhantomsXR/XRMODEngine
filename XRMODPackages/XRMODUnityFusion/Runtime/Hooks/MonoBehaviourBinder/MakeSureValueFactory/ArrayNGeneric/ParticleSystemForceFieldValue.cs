...
{
    public class ParticleSystemForceFieldValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<ParticleSystemForceField>().ToList()
                    : convertedArray.Cast<ParticleSystemForceField>().ToArray());
            return true;
