...
{
    public class SkinnedMeshRendererValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<SkinnedMeshRenderer>().ToList()
                    : convertedArray.Cast<SkinnedMeshRenderer>().ToArray());
            return true;
