...
{
    public class SpriteShapeRendererValue:ArrayAndGenericMixMakeSureAction
    {
        public override bool MakeSureValue(ref FieldInfo _fieldInfo, object _target, object _value)
        {
            ...
            _fieldInfo.SetValue(_target,
                isGenericList
                    ? convertedArray.Cast<SpriteShapeRenderer>().ToList()
                    : convertedArray.Cast<SpriteShapeRenderer>().ToArray());
            return true;
