...
{
    public class UnityFusionParameterInfo : ParameterInfo
    {
        public IType IType { get; private set; }
        public UnityFusion.Runtime.Enviorment.AppDomain AppDomain{ get; private set; }

        Mono.Cecil.ParameterDefinition definition;
        Attribute[] customAttributes;
        Type[] attributeTypes;

        public UnityFusionParameterInfo(Mono.Cecil.ParameterDefinition definition, IType type, MemberInfo member, UnityFusion.Runtime.Enviorment.AppDomain appdomain)
        {
            this.IType = type;
