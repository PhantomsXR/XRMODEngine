...
using UnityFusion.Runtime.Debugger.Protocol;
#if UNITYFUSION_ENABLE_ROSYLN
...
namespace UnityFusion.Runtime.Debugger
{
    public class DebugService
    {
        ...
        public Action<string> OnUnityFusionException;
        ...
        public string GetStackTrace(ILIntepreter intepreper)
        {
            ...
            UnityFusion.CLR.Method.ILMethod m;
            ...
            if (AppDomain.Intepreters.TryGetValue(threadHashCode, out intepreter))
            {
                ...
                if (obj != null)
                {
                    ...
                    else
                    {
                        ...
                        //else
                        //{
                        //if(obj is UnityFusion.Runtime.Enviorment.CrossBindingAdaptorType)
                        //{
