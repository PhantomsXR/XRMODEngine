...
namespace UnityFusion.CLR.Utils
{
    ...
    public static class Extensions
    {
        ...
        public static List<IType> GetParamList(this MethodReference def, UnityFusion.Runtime.Enviorment.AppDomain appdomain, IType contextType, IMethod contextMethod, IType[] genericArguments)
        {
        ...
        public static TypeFlags GetTypeFlags(this Type pt)
        {
            ...
            if(pt is UnityFusionWrapperType)
            {
                pt = ((UnityFusionWrapperType)pt).RealType;
            }
        ...
        public static object CheckCLRTypes(this Type pt, object obj, TypeFlags typeFlags)
        {
            ...
            else if (obj is UnityFusion.Reflection.UnityFusionWrapperType)
            {
                obj = ((UnityFusion.Reflection.UnityFusionWrapperType)obj).RealType;
            }
        ...
        {
            if (type is UnityFusionWrapperType)
                return (type as UnityFusionWrapperType).RealType;
            return type;
        }
    }
}
