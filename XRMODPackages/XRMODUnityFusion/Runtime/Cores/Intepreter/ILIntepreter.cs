...
using UnityFusion.Runtime.Intepreter.OpCodes;
using UnityFusion.Runtime.Debugger;
...
#endif
namespace UnityFusion.Runtime.Intepreter
{
...
#pragma warning disable CS0414
                ...
                while (!returned)
                {
                        ...
                        switch (code)
                        {
                            ...
                            case OpCodeEnum.Stobj:
                            {
                                ...
                                switch (objRef->ObjectType)
                                {
                                    ...
                                    case ObjectTypes.FieldReference:
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (!((CLRType) t).AssignFieldFromStack(idx, ref obj, this, val, mStack))
                                                ((CLRType) t).SetFieldValue(idx, ref obj,
                                                    t.TypeForCLR.CheckCLRTypes(
                                                        StackObject.ToObject(val, AppDomain, mStack)));
                                        }
                                    }
                                        break;
                                    case ObjectTypes.StaticFieldReference:
                                    {
                                        ...
                                        if (t is ILType)
                                        {
                                            ((ILType) t).StaticInstance.AssignFromStack(objRef->ValueLow, val,
                                                AppDomain, mStack);
                                        }
                                        else
                                        {
                                            obj = null;
                                            if (!((CLRType) t).AssignFieldFromStack(objRef->ValueLow, ref obj, this,
                                                    val, mStack))
                                                ((CLRType) t).SetStaticFieldValue(objRef->ValueLow,
                                                    t.TypeForCLR.CheckCLRTypes(
                                                        StackObject.ToObject(val, AppDomain, mStack)));
                                        }
                                    }
                            ...
                            case OpCodeEnum.Ldind_U4:
                            {
                                ...
                                switch (val->ObjectType)
                                {
                                    ...
                                    case ObjectTypes.ArrayReference:
                                    {
                                        ...
                                        intVal = val->ValueLow;
                                        Free(dst);
                                        LoadFromArrayReference(obj, intVal, dst, obj.GetType().GetElementType(),
                                            mStack);
                                    }
                                        break;
                                    case ObjectTypes.StaticFieldReference:
                            ...
                            case OpCodeEnum.Stind_R4:
                            {
                                ...
                                switch (dst->ObjectType)
                                {
                                    ...
                                    case ObjectTypes.ArrayReference:
                                    {
                                        StoreValueToArrayReference(dst, val,
                                            mStack[dst->Value].GetType().GetElementType(), mStack);
                                    }
                                        break;
                                    case ObjectTypes.StaticFieldReference:
                                    {
                                        ...
                                        if (type != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                obj = null;
                                                if (!((CLRType) t).AssignFieldFromStack(intVal, ref obj, this, val,
                                                        mStack))
                                                    t.SetStaticFieldValue(intVal,
                                                        f.FieldType.CheckCLRTypes(
                                                            CheckAndCloneValueType(
                                                                StackObject.ToObject(val, domain, mStack), domain)));
                                            }
                                        }
                                        else
                            ...
                            case OpCodeEnum.Callvirt:
                            {
                                ...
                                if (m == null)
                                {
                                    ...
                                    if (exToken > 0)
                                    {
                                        ...
                                        if (ex != null)
                                        {
                                            throw new UnityFusionException(ex.Message, this, method, ex);
                                        }
                                    }
                                ...
                                else
                                {
                                    if (m is ILMethod)
                                    {
                                        ...
                                        {
                                            obj = StackObject.ToObject((Minus(esp, m.ParameterCount + 1)), domain,
                                                mStack);
                                        ...
                                        if (!processed)
                                        {
                                            ...
                                            {
                                                objRef = GetObjectAndResolveReference(
                                                    Minus(esp, ilm.ParameterCount + 1));
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            obj = StackObject.ToObject((Minus(esp, cm.ParameterCount + 1)), domain,
                                                mStack);
                                            if (obj is IDelegateAdapter)
                                            {
                                                if (cm.IsDelegateDynamicInvoke)
                                                {
                                                    arrRef = esp - 1;
                                                    object[] objArr =
                                                        StackObject.ToObject(arrRef, domain, mStack) as object[];
                                                    Free(arrRef);
                                                    if (objArr != null)
                                                    {
                                                        if (objArr.Length != cm.ParameterCount)
                                                            throw new ArgumentException(
                                                                string.Format("{0}.{1} has {2} arguments, but got {3}",
                                                                    cm.DeclearingType.FullName, cm.Name,
                                                                    cm.ParameterCount, objArr.Length));
                                                        esp = arrRef;
                                                        for (intVal = 0; intVal < objArr.Length; intVal++)
                                                        {
                                                            esp = PushObject(esp, mStack, objArr[intVal],
                                                                cm.Parameters[intVal] == domain.ObjectType);
                                                        }
                                                    }
                                                }
                                            ...
                                            else
                                            {
                                                ...
                                                if (cm.ReturnType != AppDomain.VoidType && !cm.IsConstructor)
                                                {
                                                    esp = PushObject(esp, mStack, result,
                                                        cm.ReturnType.TypeForCLR == typeof(object));
                                                }
                                            }
                                        }
                                    }
                            ...
                            case OpCodeEnum.Stfld:
                            {
                                ...
                                if (objRef->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                {
                                    ...
                                    if (ft is ILType)
                                        ...
                                        CopyToValueTypeField(dst, ((CLRType) ft).FieldIndexMapping[(int) ip->TokenLong],
                                            esp - 1, mStack);
                                }
                                else
                                {
                                    ...
                                    if (obj != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (type != null)
                                            {
                                                ...
                                                if (!((CLRType) type).AssignFieldFromStack(fieldToken, ref obj, this,
                                                        val, mStack))
                                                    ((CLRType) type).SetFieldValue(fieldToken, ref obj,
                                                        f.FieldType.CheckCLRTypes(
                                                            CheckAndCloneValueType(
                                                                StackObject.ToObject(val, domain, mStack), domain)));
                                                //Writeback
                            ...
                            case OpCodeEnum.Ldfld:
                            {
                                ...
                                if (objRef->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                {
                                    ...
                                    if (val->ObjectType == ObjectTypes.ValueTypeObjectReference &&
                                        ret->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                    {
                                    ...
                                    if (obj != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (type != null)
                                            {
                                                ...
                                                if (!((CLRType) type).CopyFieldToStack(token, obj, this, ref ret,
                                                        mStack))
                                                {
                            ...
                            case OpCodeEnum.Ldflda:
                            {
                                ...
                                if (objRef->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                {
                                    ...
                                    if (ft is ILType)
                                    {
                                        fieldAddr = Minus(ILIntepreter.ResolveReference(objRef),
                                            (int) ip->TokenLong + 1);
                                    }
                                    else
                                    {
                                        fieldAddr = Minus(ILIntepreter.ResolveReference(objRef),
                                            ((CLRType) ft).FieldIndexMapping[(int) ip->TokenLong] + 1);
                                    }
                            ...
                            case OpCodeEnum.Stsfld:
                            {
                                ...
                                if (type != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        obj = null;
                                        if (!((CLRType) t).AssignFieldFromStack(idx, ref obj, this, val, mStack))
                                            t.SetStaticFieldValue(idx,
                                                f.FieldType.CheckCLRTypes(
                                                    CheckAndCloneValueType(StackObject.ToObject(val, domain, mStack),
                                                        domain)));
                                    }
                                }
                                else
                            ...
                            case OpCodeEnum.Ldvirtftn:
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        m = ((CrossBindingAdaptorType) obj).ILInstance.Type.BaseType
                                            .GetVirtualMethod(m);
                                    }
                                }
                                ...
                                switch (obj1->ObjectType)
                                {
                                    case ObjectTypes.Integer:
                                        res = (uint) obj1->Value < (uint) obj2->Value &&
                                              obj2->ObjectType != ObjectTypes.Null;
                                        break;
                                    case ObjectTypes.Long:
                                    ...
                                    if (type.IsDelegate)
                                    {
                                        ...
                                        if (ilMethod != null)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                {
                                                    var invokeMethod = type.GetMethod("Invoke", mi.ParameterCount);
                                                    ilMethod.DelegateAdapter =
                                                        domain.DelegateManager.FindDelegateAdapter(null, ilMethod,
                                                            invokeMethod);
                                                }
                                    ...
                                    else
                                    {
                                        if (cm.DeclearingType.IsDelegate)
                                        {
                                            ...
                                            if (ilMethod != null)
                                            {
                                                ...
                                                dele = domain.DelegateManager.FindDelegateAdapter(
                                                    (CLRType) cm.DeclearingType, (ILTypeInstance) ins, ilMethod);
                                            }
                                            else
                                            {
                                                if (ins is ILTypeInstance)
                                                    ins = ((ILTypeInstance) ins).CLRInstance;
                                                dele = Delegate.CreateDelegate(cm.DeclearingType.TypeForCLR, ins,
                                                    ((CLRMethod) mi).MethodInfo);
                                            }
                            ...
                            case OpCodeEnum.Constrained:
                            {
                                ...
                                if (type != null)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (tt.IsEnum)
                                        {
                                            mStack[insIdx] = Enum.ToObject(tt,
                                                StackObject.ToObject(objRef2, AppDomain, mStack));
                                            objRef->ObjectType = ObjectTypes.Object;
                                            objRef->Value = insIdx;
                                        ...
                                        {
                                            mStack[insIdx] =
                                                tt.CheckCLRTypes(StackObject.ToObject(objRef2, AppDomain, mStack));
                                            objRef->ObjectType = ObjectTypes.Object;
                                            objRef->Value = insIdx;
                                    ...
                                    else
                                    {
                                        if (type.TypeForCLR.IsPrimitive)
                                        {
                                            ...
                                            else if (t == typeof(float))
                                            {
                                                ...
                                                {
                                                    case ObjectTypes.Float:
                                                        esp = PushObject(objRef, mStack, *(float*) &objRef->Value,
                                                            true);
                                                        break;
                                                    case ObjectTypes.Null:
                                            ...
                                            else if (t == typeof(double))
                                            {
                                                ...
                                                {
                                                    case ObjectTypes.Double:
                                                        esp = PushObject(objRef, mStack, *(double*) &objRef->Value,
                                                            true);
                                                        break;
                                                    case ObjectTypes.Null:
                                            ...
                                            else if (t == typeof(ulong))
                                            {
                                                ...
                                                {
                                                    case ObjectTypes.Long:
                                                        esp = PushObject(objRef, mStack, *(ulong*) &objRef->Value,
                                                            true);
                                                        break;
                                                    case ObjectTypes.Null:
                                        ...
                                        {
                                            esp = PushObject(objRef, mStack,
                                                Enum.ToObject(type.TypeForCLR,
                                                    StackObject.ToObject(objRef, AppDomain, mStack)), true);
                                        }
                                        else
                                        {
                                            if (objRef->ObjectType == ObjectTypes.ValueTypeObjectReference)
                                    ...
                                    else
                                    {
                                        ...
                                        switch (objRef->ObjectType)
                                        {
                                            case ObjectTypes.StaticFieldReference:
                                            {
                                                ...
                                                t.StaticInstance.AssignFromStack(objRef->ValueLow, esp, AppDomain,
                                                    mStack);
                                            }
                                                break;
                                            case ObjectTypes.FieldReference:
                                        ...
                                        if (obj != null)
                                        {
                                            if (obj is ILTypeInstance)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        curType =
                                                            $"{((DelegateAdapter) obj).Method.DeclearingType.FullName}.{((DelegateAdapter) obj).Method.Name}";
                                                    }
                                                    else
                                                        curType = ((ILTypeInstance) obj).Type.FullName;

                                                    throw new InvalidCastException(
                                                        string.Format("Cannot Cast {0} to {1}", curType,
                                                            type.FullName));
                                                }
                                            }
                                            else
                                            {
                                                ...
                                                {
                                                    throw new InvalidCastException(
                                                        string.Format("Cannot Cast {0} to {1}", obj.GetType().FullName,
                                                            type.FullName));
                                                }
                                            }
                                        }
                                ...
                                if (type != null)
                                {
                                    ...
                                    if (objRef->ObjectType <= ObjectTypes.Double)
                                    {
                                        ...
                                        switch (objRef->ObjectType)
                                        {
                                            case ObjectTypes.Integer:
                                            {
                                                if (tclr != typeof(int) && tclr != typeof(bool) &&
                                                    tclr != typeof(short) && tclr != typeof(byte) &&
                                                    tclr != typeof(ushort) && tclr != typeof(uint))
                                                {
                                                    oriRef->ObjectType = ObjectTypes.Null;
                                                    oriRef->Value = -1;
                                                    oriRef->ValueLow = 0;
                            ...
                            case OpCodeEnum.Ldelem_Any:
                            {
                                ...
                                if (obj is ILTypeInstance)
                                {
                                    ...
                                    esp = PushObject(esp - 1 - 1, mStack, obj,
                                        !arr.GetType().GetElementType().IsPrimitive);
                            }
                                break;
                    ...
                    catch (Exception ex)
                    {
                        if (ehs != null)
                        {
                            ...
                            if (eh != null)
                            {
                                if (ex is UnityFusionException)
                                {
                                    UnityFusionException ire = (UnityFusionException) ex;
                                    var inner = ire.InnerException;
                                    inner.Data["ThisInfo"] = ire.ThisInfo;
                                    inner.Data["StackTrace"] = inner.Data.Contains("StackTrace")
                                        ? string.Format("{0}\n--- End of stack trace from previous location ---\n{1}",
                                            ire.StackTrace, inner.Data["StackTrace"])
                                        : ire.StackTrace;
                                ...
                                else
                                {
                                    ...
                                    if (method.HasThis)
                                        ...
                                        ex.Data["ThisInfo"] = "";
                                    ex.Data["StackTrace"] = ex.Data.Contains("StackTrace")
                                        ? string.Format("{0}\n--- End of stack trace from previous location ---\n{1}",
                                            debugger.GetStackTrace(this), ex.Data["StackTrace"])
                                        : debugger.GetStackTrace(this);
                            ...
                            if (eh == null)
                                eh = GetCorrespondingExceptionHandler(ehs, null, addr, ExceptionHandlerType.Finally,
                                    false);
                            if (eh != null)
                            {
                                unhandledException = false;
                                finallyEndAddress = -1;
                                lastCaughtEx = ex is UnityFusionException
                                    ? ex
                                    : new UnityFusionException(ex.Message, this, method, ex);
                                ip = ptr + eh.HandlerStart;
                                continue;
                            }
                        }
...
#endif
                        {
                            var newEx = new UnityFusionException(ex.Message, this, method, ex);
                            throw newEx;
                        }
                    }
                }
        ...
        bool CanCopyStackValueType(StackObject* src, StackObject* dst)
        {
            if (src->ObjectType == ObjectTypes.ValueTypeObjectReference &&
                dst->ObjectType == ObjectTypes.ValueTypeObjectReference)
            {
                StackObject* descriptor = ILIntepreter.ResolveReference(src);
                StackObject* dstDescriptor = ILIntepreter.ResolveReference(dst);
        ...
        ExceptionHandler GetCorrespondingExceptionHandler(ExceptionHandler[] eh, object obj, int addr,
            ExceptionHandlerType type, bool explicitMatch)
        {
            ExceptionHandler res = null;
            int distance = int.MaxValue;
            Exception ex = obj is UnityFusionException ? ((UnityFusionException) obj).InnerException : obj as Exception;
            foreach (var i in eh)
            {
        ...
        void StoreValueToFieldReference(ref object obj, int idx, StackObject* val, AutoList mStack)
        {
            ...
            else
            {
                ...
                {
                    var v = obj.GetType()
                        .CheckCLRTypes(CheckAndCloneValueType(StackObject.ToObject(val, AppDomain, mStack), AppDomain));
                    t.SetFieldValue(idx, ref obj, v, true);
                }
            }
        }

        void LoadFromArrayReference(object obj, int idx, StackObject* objRef, IType t, AutoList mStack,
            int managedIdx = -1)
        {
            var nT = t.TypeForCLR;
        ...
        void LoadFromArrayReference(object obj, int idx, StackObject* objRef, Type nT, AutoList mStack,
            int managedIdx = -1)
        {
            if (nT.IsPrimitive)
            {
        ...
        [Obsolete]
        public static void UnboxObject(StackObject* esp, object obj, IList<object> mStack = null,
            Enviorment.AppDomain domain = null)
        {
            UnboxObject(esp, obj, (AutoList) mStack, domain);
        }

        public static void UnboxObject(StackObject* esp, object obj, AutoList mStack = null,
            Enviorment.AppDomain domain = null)
        {
        ...
        public void FreeStackValueType(StackObject* esp)
        {
            if (esp->ObjectType == ObjectTypes.ValueTypeObjectReference)
            {
                ...
                if (addr <=
                    ValueTypeBasePointer) //Only Stack allocation after base pointer should be freed, local variable are freed automatically
