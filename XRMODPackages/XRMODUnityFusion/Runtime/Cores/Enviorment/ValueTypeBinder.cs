...
namespace UnityFusion.Runtime.Enviorment
{
    ...
    public unsafe abstract class ValueTypeBinder<T> : ValueTypeBinder
    {
        ...
        public void WriteBackValue(UnityFusion.Runtime.Enviorment.AppDomain domain, StackObject* ptr_of_this_method, IList<object> mStack, ref T instance_of_this_method)
        {
