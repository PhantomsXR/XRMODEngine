...
#endif
namespace UnityFusion.Runtime.Enviorment
{
    unsafe static class CLRRedirections
    {
        ...
        public static StackObject* CreateInstance2(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (t != null)
            {
                if (t is UnityFusionType)
                {
                    return ILIntepreter.PushObject(p, mStack, ((UnityFusionType)t).ILType.Instantiate());
                }
                else
        ...
        /*public static object CreateInstance2(ILContext ctx, object instance, object[] param, IType[] genericArguments)
        {
            ...
            if (t != null)
            {
                if (t is UnityFusionType)
                {
                    return ((UnityFusionType)t).ILType.Instantiate();
                }
                else
        ...
        public static StackObject* CreateInstance3(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (t != null)
            {
                ...
                if (t is UnityFusionType)
                {
                    return ILIntepreter.PushObject(p, mStack, ((UnityFusionType)t).ILType.Instantiate(t2));
                }
                else
        ...
        public static StackObject* TypeEquals(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            intp.Free(p);
            if (instance is UnityFusionType)
            {
                if (other is UnityFusionType)
                {
                    if (((UnityFusionType)instance).ILType == ((UnityFusionType)other).ILType)
        ...
        public static StackObject* IsAssignableFrom(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (instance is UnityFusionType)
            {
                if (other is UnityFusionType)
                {
                    if (((UnityFusionType)instance).IsAssignableFrom((UnityFusionType)other))
                        return ILIntepreter.PushOne(ret);
                    else
                        return ILIntepreter.PushZero(ret);
                }
            ...
            {
                if (instance is UnityFusionWrapperType)
                {
                    if (((UnityFusionWrapperType)instance).IsAssignableFrom((Type)other))
                        return ILIntepreter.PushOne(ret);
                    else
                        return ILIntepreter.PushZero(ret);
                }
        ...
        public unsafe static StackObject* MethodInfoInvoke(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (instance is UnityFusionMethodInfo)
            {
                if (obj != null)
                    esp = ILIntepreter.PushObject(ret, mStack, obj);
                else
                    esp = ret;
                var ilmethod = ((UnityFusionMethodInfo)instance).ILMethod;
                ...
                UnityFusionMethodInfo imi = (UnityFusionMethodInfo)instance;
        ...
        public static StackObject* EnumParse(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (t is UnityFusionType)
            {
                ILType it = ((UnityFusionType)t).ILType;
                if (it.IsEnum)
                {
            ...
            else if (t is UnityFusionWrapperType)
            {
                return ILIntepreter.PushObject(ret, mStack, Enum.Parse(((UnityFusionWrapperType)t).RealType, name), true);
            }
            else
        ...
        public static StackObject* EnumGetValues(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            {
                return ILIntepreter.PushObject(ret, mStack, Enum.GetValues(((UnityFusionWrapperType)t).RealType), true);
            }
            else
        ...
        public static StackObject* EnumGetNames(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            {
                return ILIntepreter.PushObject(ret, mStack, Enum.GetNames(((UnityFusionWrapperType)t).RealType), true);
            }
            else
        ...
        public static StackObject* EnumGetName(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            {
                return ILIntepreter.PushObject(ret, mStack, Enum.GetName(((UnityFusionWrapperType)t).RealType, val), true);
            }
            else
        ...
        public static StackObject* DelegateCreateDelegate(ILIntepreter intp, StackObject* esp, AutoList mStack, CLRMethod method, bool isNewObj)
        {
            ...
            if (t is UnityFusionType)
            {
                ...
                if (it.IsDelegate)
                {
                    ...
                    object ins = null;
                    if (mi is UnityFusionMethodInfo)
                    {
                        UnityFusionMethodInfo imi = (UnityFusionMethodInfo)mi;
            ...
            {
                UnityFusionWrapperType iwt = (UnityFusionWrapperType)t;
                object ins = null;
                if (mi is UnityFusionMethodInfo)
                {
                    UnityFusionMethodInfo imi = (UnityFusionMethodInfo)mi;
        ...
        {
            if (type is UnityFusionType)
            {
                return ((UnityFusionType)type).ILType;
            }
            else if (type is UnityFusionWrapperType)
            {
                return ((UnityFusionWrapperType)type).CLRType;
            }
            else
