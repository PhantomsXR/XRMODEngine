...
namespace UnityFusion.Runtime.Generated
{
    unsafe class System_Collections_Generic_Stack_1_Transform_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new System.Collections.Generic.Stack<UnityEngine.Transform>());
            app.RegisterCLRCreateArrayInstance(type, s => new System.Collections.Generic.Stack<UnityEngine.Transform>[s]);
        ...
        static StackObject* CopyTo_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.Transform[] @array = (UnityEngine.Transform[])typeof(UnityEngine.Transform[]).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<UnityEngine.Transform> @collection = (System.Collections.Generic.IEnumerable<UnityEngine.Transform>)typeof(System.Collections.Generic.IEnumerable<UnityEngine.Transform>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = new System.Collections.Generic.Stack<UnityEngine.Transform>(@collection);
