...
namespace UnityFusion.Runtime.Generated
{
    unsafe class System_DateTime_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ToShortDateString_0);
            args = new Type[]{};
            method = type.GetMethod("ToLongTimeString", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToLongTimeString_1);
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref System.DateTime instance_of_this_method)
        {
        ...
        static StackObject* ToShortDateString_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* ToLongTimeString_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
