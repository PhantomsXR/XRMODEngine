...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_CapsuleCollider2D_Binding
    {
        ...
        static StackObject* get_size_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.CapsuleCollider2D instance_of_this_method = (UnityEngine.CapsuleCollider2D)typeof(UnityEngine.CapsuleCollider2D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* set_direction_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.CapsuleDirection2D @value = (UnityEngine.CapsuleDirection2D)typeof(UnityEngine.CapsuleDirection2D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            __intp.Free(ptr_of_this_method);
