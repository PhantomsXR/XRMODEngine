...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_ConstantForce2D_Binding
    {
        ...
        static StackObject* get_force_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.ConstantForce2D instance_of_this_method = (UnityEngine.ConstantForce2D)typeof(UnityEngine.ConstantForce2D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
