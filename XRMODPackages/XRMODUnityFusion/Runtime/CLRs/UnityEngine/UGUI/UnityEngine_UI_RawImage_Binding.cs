...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_UI_RawImage_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_texture_2);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, set_uvRect_4);
            args = new Type[]{};
            method = type.GetMethod("SetNativeSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetNativeSize_5);



            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.UI.RawImage[s]);
        ...
        static StackObject* set_texture_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_uvRect_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* SetNativeSize_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
