...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_Bounds_Binding
    {
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain,
            StackObject* ptr_of_this_method, AutoList __mStack, ref UnityEngine.Bounds instance_of_this_method)
        {
        ...
        static StackObject* get_center_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            ...
            UnityEngine.Bounds instance_of_this_method =
                (UnityEngine.Bounds) typeof(UnityEngine.Bounds).CheckCLRTypes(
            ...
            {
                UnityEngineClrBinding.s_UnityEngine_Vector3_Binding_Binder.PushValue(ref result_of_this_method, __intp,
                    __ret, __mStack);
                return __ret + 1;
            }
            else
        ...
        static StackObject* get_size_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method,
            bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
