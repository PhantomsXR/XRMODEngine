...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_Resolution_Binding
    {
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref UnityEngine.Resolution instance_of_this_method)
        {
