...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_Touch_Binding
    {
        ...
        static void WriteBackInstance(UnityFusion.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, AutoList __mStack, ref UnityEngine.Touch instance_of_this_method)
        {
        ...
        static StackObject* get_phase_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
