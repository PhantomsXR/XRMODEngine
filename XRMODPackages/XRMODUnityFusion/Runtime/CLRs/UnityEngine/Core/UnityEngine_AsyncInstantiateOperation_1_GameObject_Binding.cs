...
namespace UnityFusion.Runtime.Generated
{
    ...
    unsafe class UnityEngine_AsyncInstantiateOperation_1_GameObject_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.AsyncInstantiateOperation<UnityEngine.GameObject>);
            args = new Type[] { };
            ...
            bool isNewObj)
        {
            ...
            UnityEngine.AsyncInstantiateOperation<UnityEngine.GameObject> instance_of_this_method =
                (UnityEngine.AsyncInstantiateOperation<UnityEngine.GameObject>)
                typeof(UnityEngine.AsyncInstantiateOperation<UnityEngine.GameObject>).CheckCLRTypes(
