...
{
    unsafe class UnityEngine_ScriptableObject_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.ScriptableObject);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.ScriptableObject());
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.ScriptableObject[s]);
        ...
        static StackObject* CreateInstance_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.ScriptableObject.CreateInstance(@className);
        ...
        static StackObject* CreateInstance_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.ScriptableObject.CreateInstance(@type);
