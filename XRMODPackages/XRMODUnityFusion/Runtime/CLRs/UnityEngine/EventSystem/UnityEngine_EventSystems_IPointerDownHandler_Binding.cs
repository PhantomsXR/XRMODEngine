...
{
    unsafe class UnityEngine_EventSystems_IPointerDownHandler_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.EventSystems.IPointerDownHandler);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.EventSystems.IPointerDownHandler[s]);
        ...
        static StackObject* OnPointerDown_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.EventSystems.IPointerDownHandler instance_of_this_method = (UnityEngine.EventSystems.IPointerDownHandler)typeof(UnityEngine.EventSystems.IPointerDownHandler).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
