...
namespace UnityFusion.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_EventTrigger_Binding_Entry_Binding
    {
        ...
        static StackObject* CopyToStack_callback_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
        ...
        static StackObject* AssignFromStack_callback_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
