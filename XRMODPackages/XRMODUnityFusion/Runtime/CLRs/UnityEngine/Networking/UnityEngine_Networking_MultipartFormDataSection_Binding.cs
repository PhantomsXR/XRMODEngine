...
{
    unsafe class UnityEngine_Networking_MultipartFormDataSection_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Networking.MultipartFormDataSection);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new UnityEngine.Networking.MultipartFormDataSection[s]);

            args = new Type[]{typeof(System.String), typeof(System.Byte[]), typeof(System.String)};
        ...
        static StackObject* get_sectionName_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Networking.MultipartFormDataSection instance_of_this_method = (UnityEngine.Networking.MultipartFormDataSection)typeof(UnityEngine.Networking.MultipartFormDataSection).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Networking.MultipartFormDataSection(@name, @data, @contentType);
        ...
        static StackObject* Ctor_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Networking.MultipartFormDataSection(@name, @data);
        ...
        static StackObject* Ctor_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Networking.MultipartFormDataSection(@data);
        ...
        static StackObject* Ctor_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new UnityEngine.Networking.MultipartFormDataSection(@name, @data, @encoding, @contentType);
        ...
        static StackObject* Ctor_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
