...
{
    [CustomEditor(typeof(UIBehaviourAdaptor.Adapter), true)]
    public class UIBehaviourAdapterEditor : UnityEditor.Editor
    {
        private Dictionary<Type, bool> foldouts = new Dictionary<Type, bool>();

        public override void OnInspectorGUI()
        {
            UIBehaviourAdaptor.Adapter tmp_Clr = target as UIBehaviourAdaptor.Adapter;
