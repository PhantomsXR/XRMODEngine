...
{
    public class GameObjectArrayValueDrawer : IMonoFieldValueDraw
    {
        ...
        {
            var tmp_GameObjectArrayProperty =
                _property.FindPropertyRelative(nameof(MonoField.FieldTypeEnum.GameObjectArray));
            DrawerUtils.MakeSureUnityObjectField(_fieldRect, ref tmp_GameObjectArrayProperty);
        }
    }
}