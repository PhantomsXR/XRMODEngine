...
{
    unsafe class Fusion_NetworkPrefabSourceResource_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Fusion.NetworkPrefabSourceResource);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Fusion.NetworkPrefabSourceResource());
            app.RegisterCLRCreateArrayInstance(type, s => new Fusion.NetworkPrefabSourceResource[s]);
        ...
        {
            return ((Fusion.NetworkPrefabSourceResource)o).AssetGuid;
        }

        static StackObject* CopyToStack_AssetGuid_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Fusion.NetworkPrefabSourceResource)o).AssetGuid;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_AssetGuid_0(ref object o, object v)
        {
            ((Fusion.NetworkPrefabSourceResource)o).AssetGuid = (Fusion.NetworkObjectGuid)v;
        }
        ...
        static StackObject* AssignFromStack_AssetGuid_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Fusion.NetworkPrefabSourceResource)o).AssetGuid = @AssetGuid;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.NetworkPrefabSourceResource();
