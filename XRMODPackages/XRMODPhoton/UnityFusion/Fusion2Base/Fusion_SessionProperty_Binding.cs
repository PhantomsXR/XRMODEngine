...
{
    unsafe class Fusion_SessionProperty_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.SessionProperty);
            MethodInfo[] methods = type.GetMethods(flag).Where(t => !t.IsGenericMethod).ToArray();
            args = new Type[]{typeof(System.String)};
            method = methods.Where(t => t.Name.Equals("op_Implicit") && t.ReturnType == typeof(Fusion.SessionProperty) && t.CheckMethodParams(args)).Single();
        ...
        static StackObject* op_Implicit_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = (Fusion.SessionProperty)v;
