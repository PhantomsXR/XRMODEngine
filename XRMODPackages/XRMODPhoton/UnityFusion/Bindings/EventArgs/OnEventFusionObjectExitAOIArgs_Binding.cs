...
{
    unsafe class OnEventFusionObjectExitAOIArgs_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs[s]);
        ...
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).PlayerRef;
        }

        static StackObject* CopyToStack_PlayerRef_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).PlayerRef;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_PlayerRef_0(ref object o, object v)
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).PlayerRef = (Fusion.PlayerRef)v;
        }
        ...
        static StackObject* AssignFromStack_PlayerRef_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).PlayerRef = @PlayerRef;
            return ptr_of_this_method;
        }

        static object get_NetworkObject_1(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).NetworkObject;
        }

        static StackObject* CopyToStack_NetworkObject_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).NetworkObject;
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).NetworkObject = (Fusion.NetworkObject)v;
        }
        ...
        static StackObject* AssignFromStack_NetworkObject_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs)o).NetworkObject = @NetworkObject;
            return ptr_of_this_method;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.PhotonModule.Runtime.OnEventFusionObjectExitAOIArgs();
