...
{
    unsafe class Fusion_Addons_Physics_NetworkRigidbody3D_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Fusion.Addons.Physics.NetworkRigidbody3D);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Fusion.Addons.Physics.NetworkRigidbody3D());
            app.RegisterCLRCreateArrayInstance(type, s => new Fusion.Addons.Physics.NetworkRigidbody3D[s]);
        ...
        static StackObject* get_RBPosition_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Addons.Physics.NetworkRigidbody3D instance_of_this_method = (Fusion.Addons.Physics.NetworkRigidbody3D)typeof(Fusion.Addons.Physics.NetworkRigidbody3D).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.Physics.NetworkRigidbody3D();
