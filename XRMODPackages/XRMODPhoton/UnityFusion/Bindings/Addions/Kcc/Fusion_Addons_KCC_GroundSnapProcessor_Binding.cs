...
{
    unsafe class Fusion_Addons_KCC_GroundSnapProcessor_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Fusion.Addons.KCC.GroundSnapProcessor);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Fusion.Addons.KCC.GroundSnapProcessor());
            app.RegisterCLRCreateArrayInstance(type, s => new Fusion.Addons.KCC.GroundSnapProcessor[s]);
        ...
        static StackObject* GetPriority_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Fusion.Addons.KCC.GroundSnapProcessor instance_of_this_method = (Fusion.Addons.KCC.GroundSnapProcessor)typeof(Fusion.Addons.KCC.GroundSnapProcessor).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        {
            return Fusion.Addons.KCC.GroundSnapProcessor.DefaultPriority;
        }

        static StackObject* CopyToStack_DefaultPriority_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = Fusion.Addons.KCC.GroundSnapProcessor.DefaultPriority;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Fusion.Addons.KCC.GroundSnapProcessor();
