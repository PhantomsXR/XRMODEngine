...
{
    unsafe class NetworkCharacterControllerLocalPositionSync_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync[s]);
        ...
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).gravity;
        }

        static StackObject* CopyToStack_gravity_0(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).gravity;
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).gravity = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_gravity_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).gravity = @gravity;
            return ptr_of_this_method;
        }

        static object get_jumpImpulse_1(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).jumpImpulse;
        }

        static StackObject* CopyToStack_jumpImpulse_1(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).jumpImpulse;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).jumpImpulse = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_jumpImpulse_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).jumpImpulse = @jumpImpulse;
            return ptr_of_this_method;
        }

        static object get_acceleration_2(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).acceleration;
        }

        static StackObject* CopyToStack_acceleration_2(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).acceleration;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).acceleration = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_acceleration_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).acceleration = @acceleration;
            return ptr_of_this_method;
        }

        static object get_braking_3(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).braking;
        }

        static StackObject* CopyToStack_braking_3(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).braking;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).braking = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_braking_3(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).braking = @braking;
            return ptr_of_this_method;
        }

        static object get_maxSpeed_4(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).maxSpeed;
        }

        static StackObject* CopyToStack_maxSpeed_4(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).maxSpeed;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).maxSpeed = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_maxSpeed_4(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).maxSpeed = @maxSpeed;
            return ptr_of_this_method;
        }

        static object get_rotationSpeed_5(ref object o)
        {
            return ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).rotationSpeed;
        }

        static StackObject* CopyToStack_rotationSpeed_5(ref object o, ILIntepreter __intp, StackObject* __ret, AutoList __mStack)
        {
            var result_of_this_method = ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).rotationSpeed;
            __ret->ObjectType = ObjectTypes.Float;
            *(float*)&__ret->Value = result_of_this_method;
            return __ret + 1;
        }
        ...
        {
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).rotationSpeed = (System.Single)v;
        }
        ...
        static StackObject* AssignFromStack_rotationSpeed_5(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, AutoList __mStack)
        {
            ...
            ((Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync)o).rotationSpeed = @rotationSpeed;
            return ptr_of_this_method;
        }
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.PhotonModule.Runtime.NetworkCharacterControllerLocalPositionSync();
