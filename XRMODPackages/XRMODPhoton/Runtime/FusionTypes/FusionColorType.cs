...
{
    public class FusionColorType:BaseFusionTypeWithChangeDetector<Color>
    {
        ...
        public bool TryGetStateSnapshots(out Color _from,out Tick _fromTick,out Color _to,out Tick _toTick,out float _alpha)
        {
