...
{
    unsafe class AuthenticationSystem_Runtime_SignInWithMetaProvider_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(AuthenticationModule.Runtime.SignInWithMetaProvider);
            args = new Type[]{};
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new AuthenticationModule.Runtime.SignInWithMetaProvider());
            app.RegisterCLRCreateArrayInstance(type, s => new AuthenticationModule.Runtime.SignInWithMetaProvider[s]);
        ...
        static StackObject* Initialize_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            AuthenticationModule.Runtime.SignInWithMetaProvider instance_of_this_method = (AuthenticationModule.Runtime.SignInWithMetaProvider)typeof(AuthenticationModule.Runtime.SignInWithMetaProvider).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new AuthenticationModule.Runtime.SignInWithMetaProvider();
