...
namespace Phantom.XRMOD.XRMODPackageTools.Editor
{
    public class ProgrammableBlock : AbstractBlock
    {
        ...
        public ProgrammableBlock(Configures _property) : base(_property)
        {
            ...
            {
                property.DomainName = $"{property.ProjectName}.Runtime";
        ...
        public override Rect DrawBlock(Rect _area)
        {
            ...
            if (foldoutToggle)
            {
                ...
                property.ProgrammableType =
                    (ProgrammableType) EditorGUILayout.EnumPopup("Programmable Type", property.ProgrammableType);
                if (property.ProgrammableType == ProgrammableType.CSharp)
                {
                    property.JitFlag =(JITFlags) EditorGUILayout.EnumPopup("JIT Type", property.JitFlag);
                ...
                {
                    property.MainVisualScripting =
                        EditorGUILayout.TextField(new GUIContent("Main Visual Scripting"),
                            property.MainVisualScripting);
                }
