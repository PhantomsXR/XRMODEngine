...
namespace Phantom.XRMOD.SDKEntry.Runtime
{
    ...
    public static class JsonWebToken
    {
        ...
        public static void ValidateToken(long _expirationTime)
        {
            var tmp_UnixTimeMilliseconds = DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
            var tmp_Offset = _expirationTime - tmp_UnixTimeMilliseconds;
            if (tmp_Offset <= 0)
            {
                throw new SignatureTimeExpirationException("Liences expiration");
            }
        }
    }
}