...
{
    unsafe class UnityEngine_XR_Interaction_Toolkit_Interactors_IXRInteractor_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.XR.Interaction.Toolkit.Interactors.IXRInteractor);
            args = new Type[]{};
