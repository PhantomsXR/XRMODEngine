...
{
    unsafe class Phantom_XRMOD_XRMODInput_Runtime_HandsAggregatorSubsystem_Binding
    {
        public static void Register(UnityFusion.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, TryGetPinchProgress_1);
            ...
            app.RegisterCLRMethodRedirection(method, TryGetJointTransform_2);
            args = new Type[]{typeof(UnityEngine.XR.Hands.XRHandJointID), typeof(UnityEngine.XR.XRNode), typeof(UnityEngine.Pose).MakeByRefType()};
            method = type.GetMethod("TryGetJointPose", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TryGetJointPose_3);
            args = new Type[]{typeof(UnityEngine.Pose)};
            method = type.GetMethod("IsPalmFacingAway", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsPalmFacingAway_4);
            args = new Type[]{typeof(UnityEngine.XR.Hands.Handedness), typeof(Phantom.XRMOD.XRMODInput.Runtime.CustomGestureData)};
            method = type.GetMethod("RegisterGestureRecognition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, RegisterGestureRecognition_5);
            args = new Type[]{typeof(UnityEngine.XR.Hands.Handedness), typeof(Phantom.XRMOD.XRMODInput.Runtime.CustomGestureData)};
            method = type.GetMethod("UnregisterGestureRecognition", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, UnregisterGestureRecognition_6);



            app.RegisterCLRCreateDefaultInstance(type, () => new Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem());
            app.RegisterCLRCreateArrayInstance(type, s => new Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem[s]);
        ...
        static StackObject* get_INSTANCE_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem.INSTANCE;
        ...
        static StackObject* TryGetPinchProgress_1(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            ...
            Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem instance_of_this_method = (Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem)typeof(Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* TryGetJointTransform_2(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* TryGetJointPose_3(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            UnityEngine.XR.XRNode @_xrhand = (UnityEngine.XR.XRNode)typeof(UnityEngine.XR.XRNode).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)20);
            ...
            var result_of_this_method = instance_of_this_method.TryGetJointPose(@_jointId, @_xrhand, out @_pose);
        ...
        static StackObject* IsPalmFacingAway_4(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.Pose @_palmJoint = (UnityEngine.Pose)typeof(UnityEngine.Pose).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)16);
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = instance_of_this_method.IsPalmFacingAway(@_palmJoint);
        ...
        static StackObject* RegisterGestureRecognition_5(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            instance_of_this_method.RegisterGestureRecognition(@_handedness, @_customGestureData);

            return __ret;
        }

        static StackObject* UnregisterGestureRecognition_6(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            UnityFusion.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
            ...
            instance_of_this_method.UnregisterGestureRecognition(@_handedness, @_customGestureData);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Phantom.XRMOD.XRMODInput.Runtime.HandsAggregatorSubsystem();
