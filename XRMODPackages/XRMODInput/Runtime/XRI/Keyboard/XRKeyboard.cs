...
namespace Phantom.XRMOD.XRMODInput.Runtime.Keyboard
{
    public class XRKeyboard : MonoBehaviour
    {
        ...
        [SerializeField, HideInInspector] string m_Text = string.Empty;
        ...
        [SerializeField, HideInInspector] TMP_InputField m_CurrentInputField;
        ...
        [SerializeField] KeyboardTextEvent m_OnTextSubmitted = new KeyboardTextEvent();
        ...
        [SerializeField] KeyboardTextEvent m_OnTextUpdated = new KeyboardTextEvent();
        ...
        [SerializeField] KeyboardKeyEvent m_OnKeyPressed = new KeyboardKeyEvent();
        ...
        [SerializeField] KeyboardModifiersEvent m_OnShifted = new KeyboardModifiersEvent();
        ...
        [SerializeField] KeyboardLayoutEvent m_OnLayoutChanged = new KeyboardLayoutEvent();
        ...
        [SerializeField] KeyboardTextEvent m_OnOpened = new KeyboardTextEvent();
        ...
        [SerializeField] KeyboardTextEvent m_OnClosed;
        ...
        [SerializeField] KeyboardTextEvent m_OnFocusChanged = new KeyboardTextEvent();
        ...
        [SerializeField] KeyboardEvent m_OnCharacterLimitReached = new KeyboardEvent();
        ...
        [SerializeField] bool m_SubmitOnEnter = true;
        ...
        [SerializeField] bool m_CloseOnSubmit;
        ...
        [SerializeField] float m_DoubleClickInterval = 2f;
        ...
        [SerializeField] List<SubsetMapping> m_SubsetLayout;
        ...
        // Reusable event args
        readonly LinkedPool<KeyboardTextEventArgs> m_KeyboardTextEventArgs =
            new LinkedPool<KeyboardTextEventArgs>(() => new KeyboardTextEventArgs(), collectionCheck: false);

        readonly LinkedPool<KeyboardLayoutEventArgs> m_KeyboardLayoutEventArgs =
            new LinkedPool<KeyboardLayoutEventArgs>(() => new KeyboardLayoutEventArgs(), collectionCheck: false);

        readonly LinkedPool<KeyboardModifiersEventArgs> m_KeyboardModifiersEventArgs =
            new LinkedPool<KeyboardModifiersEventArgs>(() => new KeyboardModifiersEventArgs(), collectionCheck: false);

        readonly LinkedPool<KeyboardKeyEventArgs> m_KeyboardKeyEventArgs =
            new LinkedPool<KeyboardKeyEventArgs>(() => new KeyboardKeyEventArgs(), collectionCheck: false);

        readonly LinkedPool<KeyboardBaseEventArgs> m_KeyboardBaseEventArgs =
            new LinkedPool<KeyboardBaseEventArgs>(() => new KeyboardBaseEventArgs(), collectionCheck: false);
