...
namespace Phantom.XRMOD.XRMODInput.Runtime
{
    ...
    public class HandVisualizer : MonoBehaviour
    {
        ...
        public UnityEvent<bool> OnLeftHandTrackingLost;
        public UnityEvent<bool> OnRightHandTrackingLost;
        public UnityEvent<bool> OnLeftHandTracked;
        public UnityEvent<bool> OnRightHandTracked;
        ...
        void OnTrackingLost(XRHand hand)
        {
            switch (hand.handedness)
            {
                case Handedness.Left:
                    UpdateRenderingVisibility(m_LeftHandGameObjects, false);
                    OnLeftHandTrackingLost?.Invoke(false);
                    break;

                case Handedness.Right:
                    UpdateRenderingVisibility(m_RightHandGameObjects, false);
                    OnRightHandTrackingLost?.Invoke(false);
                    break;
            }
        }
